...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p6tRPLsvtCczJ6SSnx+juYifkvdPc7p0Qkumd+PWj4dWDwJyUGvJ7NdfAKiVWAG/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.212.0/index.min.mjs": "sha384-p6tRPLsvtCczJ6SSnx+juYifkvdPc7p0Qkumd+PWj4dWDwJyUGvJ7NdfAKiVWAG/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.212.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xlkgzxu0cGsj1QWRCopuuO9LeZQINTf14Mojz6KEVxNJFbtuNqAMSenCluS6jvwi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.181.0/index.min.mjs": "sha384-xlkgzxu0cGsj1QWRCopuuO9LeZQINTf14Mojz6KEVxNJFbtuNqAMSenCluS6jvwi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.181.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+3+gumML9PjM5QEIbU6mt/3RBQ4omhm9WaLp7l9vJzRDJtKk+rKDGu994DYPqVM4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.476.0/index.min.mjs": "sha384-+3+gumML9PjM5QEIbU6mt/3RBQ4omhm9WaLp7l9vJzRDJtKk+rKDGu994DYPqVM4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.476.0/LICENSE
```

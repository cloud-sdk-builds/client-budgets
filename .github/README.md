...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tSRnJwKGvXn5wjkV6UF5KlHL3Vub8s0MvNR0IrDcpN6uUn80YOIES1IoDxndntzB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.513.0/index.min.mjs": "sha384-tSRnJwKGvXn5wjkV6UF5KlHL3Vub8s0MvNR0IrDcpN6uUn80YOIES1IoDxndntzB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.513.0/LICENSE
```

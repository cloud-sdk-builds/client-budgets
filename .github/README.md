...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6sPIJ8AUOtUZZ6ffzdcHAf5DdKNRVebeCSuQgEeKzMlBmdVUFu6Fz5M7HD0bSSZL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.296.0/index.min.mjs": "sha384-6sPIJ8AUOtUZZ6ffzdcHAf5DdKNRVebeCSuQgEeKzMlBmdVUFu6Fz5M7HD0bSSZL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.296.0/LICENSE
```

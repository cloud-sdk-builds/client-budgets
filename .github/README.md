...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uwEOCLbmAfH5wqwnqresrym8xGJ+FZ/o5UJAn6So/hH8euqPBb71QxFYMZ8XGau5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.329.0/index.min.mjs": "sha384-uwEOCLbmAfH5wqwnqresrym8xGJ+FZ/o5UJAn6So/hH8euqPBb71QxFYMZ8XGau5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.329.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WlQV6QjExipNVCWTj2lu5NkY1Hxz0uFhWTsREfSBPDiDkWdSeDwYSxPCf/ZjEVQ1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.981.0/index.min.mjs": "sha384-WlQV6QjExipNVCWTj2lu5NkY1Hxz0uFhWTsREfSBPDiDkWdSeDwYSxPCf/ZjEVQ1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.981.0/LICENSE
```

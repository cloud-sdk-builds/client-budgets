...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OFEF1aqTKC9/3AmlSzSGrQyzUwEDGpMkF+59jouYnDsK+AmFuGcYL6NfK1t2HWYL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.679.0/index.min.mjs": "sha384-OFEF1aqTKC9/3AmlSzSGrQyzUwEDGpMkF+59jouYnDsK+AmFuGcYL6NfK1t2HWYL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.679.0/LICENSE
```

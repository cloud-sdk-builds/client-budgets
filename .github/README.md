...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZoJu4raF+lJoeouMH0cedJyPJ6iPCD8Oj6NDI6uytJItZ6U8nZoaklReQdaaPMji
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.21.0/index.min.mjs": "sha384-ZoJu4raF+lJoeouMH0cedJyPJ6iPCD8Oj6NDI6uytJItZ6U8nZoaklReQdaaPMji"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.21.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IfL/4W65s5mwXygYFnFfFnteODCmoP4utzg414bu6FZgraWwcHRdnajyXXHAUlMs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.503.0/index.min.mjs": "sha384-IfL/4W65s5mwXygYFnFfFnteODCmoP4utzg414bu6FZgraWwcHRdnajyXXHAUlMs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.503.0/LICENSE
```

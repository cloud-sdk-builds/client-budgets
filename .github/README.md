...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2wI44ZGNoyV9fO9WPmjWNa0zEyetUV87Sv28kADpEZ/ilGf6E/3laKuRZuFq4NGJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.564.0/index.min.mjs": "sha384-2wI44ZGNoyV9fO9WPmjWNa0zEyetUV87Sv28kADpEZ/ilGf6E/3laKuRZuFq4NGJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.564.0/LICENSE
```

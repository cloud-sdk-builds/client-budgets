...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uh6/nXzxJdcJ+r83iNuipl7UYIZya5p4PD+tjuienc83JlYqhM86bM2140GLiHjq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.433.0/index.min.mjs": "sha384-uh6/nXzxJdcJ+r83iNuipl7UYIZya5p4PD+tjuienc83JlYqhM86bM2140GLiHjq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.433.0/LICENSE
```

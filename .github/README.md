...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-lSBCeMpmacyArz9I3GG9490/q+hAKuNyg6jz+lboVaj6hygTYIHJW87N9pGUKpvx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.529.1/index.min.mjs": "sha384-lSBCeMpmacyArz9I3GG9490/q+hAKuNyg6jz+lboVaj6hygTYIHJW87N9pGUKpvx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.529.1/LICENSE
```

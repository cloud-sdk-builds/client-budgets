...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U3fVpdzh3n/IKXd0jfAXwPZUhBkQUGwtT6Sp5Bu21f/t7mvibIanuCHSp6J/qa/k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.297.0/index.min.mjs": "sha384-U3fVpdzh3n/IKXd0jfAXwPZUhBkQUGwtT6Sp5Bu21f/t7mvibIanuCHSp6J/qa/k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.297.0/LICENSE
```

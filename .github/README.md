...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ax7/bXyxjqm8ys0+oBPaBN9RD8XuELtyjIwHpQJa7tRJwVgeD6LUHMQg7Fjvd5pJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.2.0/index.min.mjs": "sha384-ax7/bXyxjqm8ys0+oBPaBN9RD8XuELtyjIwHpQJa7tRJwVgeD6LUHMQg7Fjvd5pJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.2.0/LICENSE
```

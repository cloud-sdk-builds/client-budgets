...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n+144L7WUfqRH3fi/s8EEcEaeVdojWumVxhpBQy2yewQHAMj+oz9IH2FTXEO/prG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.309.0/index.min.mjs": "sha384-n+144L7WUfqRH3fi/s8EEcEaeVdojWumVxhpBQy2yewQHAMj+oz9IH2FTXEO/prG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.309.0/LICENSE
```

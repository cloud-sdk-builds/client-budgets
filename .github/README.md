...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j21Tq5WL4W8vM+ewODnfaZy7d+8QpFftQwCMlo3237Yg+Har/jTaB5KRBxLRO+7I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.980.0/index.min.mjs": "sha384-j21Tq5WL4W8vM+ewODnfaZy7d+8QpFftQwCMlo3237Yg+Har/jTaB5KRBxLRO+7I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.980.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qCkNnFExrR6ojd1VawLK1VWfat/xKk7gumw0w03eAJW6bmksETQQ18tEOzLW41UC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.848.0/index.min.mjs": "sha384-qCkNnFExrR6ojd1VawLK1VWfat/xKk7gumw0w03eAJW6bmksETQQ18tEOzLW41UC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.848.0/LICENSE
```

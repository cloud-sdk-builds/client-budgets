...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yQgicdOtXlSEwBeU8hXCsRH1PZaz41J6vp+omXsXn9zHlYbalxioFhQFhtspS+GR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.489.0/index.min.mjs": "sha384-yQgicdOtXlSEwBeU8hXCsRH1PZaz41J6vp+omXsXn9zHlYbalxioFhQFhtspS+GR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.489.0/LICENSE
```

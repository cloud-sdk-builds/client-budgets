...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cK7ISI7oBrWr+gYCoS8YbOwZW5N6r8j0lbXWBoIp5e6+LMqdo/wOFoBsrfwRJEwK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.473.0/index.min.mjs": "sha384-cK7ISI7oBrWr+gYCoS8YbOwZW5N6r8j0lbXWBoIp5e6+LMqdo/wOFoBsrfwRJEwK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.473.0/LICENSE
```

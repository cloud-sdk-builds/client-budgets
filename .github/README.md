...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rHV//ER3RwXwwLeSwgcyUVI+N5tVbWwb3+UM760UHo/De0ii3pYN66UNDUptHDQd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.78.0/index.min.mjs": "sha384-rHV//ER3RwXwwLeSwgcyUVI+N5tVbWwb3+UM760UHo/De0ii3pYN66UNDUptHDQd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.78.0/LICENSE
```

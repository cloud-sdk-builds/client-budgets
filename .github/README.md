...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ThUtHb+ClpFfQUV4YM+cj4NOHjNRP1TWTHzcJnpXHfJuZ8UhefzUHAnW40TiNAfm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.29.0/index.min.mjs": "sha384-ThUtHb+ClpFfQUV4YM+cj4NOHjNRP1TWTHzcJnpXHfJuZ8UhefzUHAnW40TiNAfm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.29.0/LICENSE
```

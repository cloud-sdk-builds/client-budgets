...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n+sLnCUcK4OgYpvuLngr+eYhOhJmsd/zu+XLEQHid5E+4tzbJxa91WkZR912/2Kv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.290.0/index.min.mjs": "sha384-n+sLnCUcK4OgYpvuLngr+eYhOhJmsd/zu+XLEQHid5E+4tzbJxa91WkZR912/2Kv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.290.0/LICENSE
```

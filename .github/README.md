...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q3t/AABN3ChDUiYGfxig8syxSxb/JZwZmcBLbspp7EukTSBUf8/MZy067AQMtXAY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.435.0/index.min.mjs": "sha384-q3t/AABN3ChDUiYGfxig8syxSxb/JZwZmcBLbspp7EukTSBUf8/MZy067AQMtXAY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.435.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.36.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.36.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-keNgC5wkjscZ1825rVw9BLOh2ma2zGWIBbLUpdPLBTpYi2wFjpe4tXTOcDX4aI+0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.36.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.36.0/index.min.mjs": "sha384-keNgC5wkjscZ1825rVw9BLOh2ma2zGWIBbLUpdPLBTpYi2wFjpe4tXTOcDX4aI+0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.36.0/LICENSE
```

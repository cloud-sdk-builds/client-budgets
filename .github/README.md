...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dU6CtAGR4WexuJHbw7OFqF9jI6DgsoYMhG3xbfUQIz39aps6TVXmaMAf80BrRUhV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.677.0/index.min.mjs": "sha384-dU6CtAGR4WexuJHbw7OFqF9jI6DgsoYMhG3xbfUQIz39aps6TVXmaMAf80BrRUhV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.677.0/LICENSE
```

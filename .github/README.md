...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ekGgUqAsDW4thjU6zDw6X+KbL7qJNy+UKh2DXH3OFkZeP+4DnmJdEr/Tr4VYZuoJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.451.0/index.min.mjs": "sha384-ekGgUqAsDW4thjU6zDw6X+KbL7qJNy+UKh2DXH3OFkZeP+4DnmJdEr/Tr4VYZuoJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.451.0/LICENSE
```

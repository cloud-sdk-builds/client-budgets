...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qQn9hfEE/7mog/QIJwgM5ExqPHqFX8j02g+8Wh50JjzHT21NgzkYlqbRtKN7zWvY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.525.0/index.min.mjs": "sha384-qQn9hfEE/7mog/QIJwgM5ExqPHqFX8j02g+8Wh50JjzHT21NgzkYlqbRtKN7zWvY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.525.0/LICENSE
```

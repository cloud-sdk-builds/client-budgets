...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3lOIfohDVQuxfvupeS3QdBqZ65cTD+shvoBpF7oZUk4bLArc8M7dIWqlod7W7gwD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.292.0/index.min.mjs": "sha384-3lOIfohDVQuxfvupeS3QdBqZ65cTD+shvoBpF7oZUk4bLArc8M7dIWqlod7W7gwD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.292.0/LICENSE
```

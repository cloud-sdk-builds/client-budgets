...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0KjXCrIhTxkx/CQRIFgGn1LasD8W49NoWWk1fyxiCEj1g0k+O4ZH0BVo0RNAPFto
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.806.0/index.min.mjs": "sha384-0KjXCrIhTxkx/CQRIFgGn1LasD8W49NoWWk1fyxiCEj1g0k+O4ZH0BVo0RNAPFto"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.806.0/LICENSE
```

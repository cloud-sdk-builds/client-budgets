...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2bieVRhfp6X+5lR4Bth+SAOkjV3yjtyel220CzO3aRzIZ8ri1u60XwqLpdOkVEc+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.118.0/index.min.mjs": "sha384-2bieVRhfp6X+5lR4Bth+SAOkjV3yjtyel220CzO3aRzIZ8ri1u60XwqLpdOkVEc+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.118.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I3Ben+Oy6X/gQLrUynpmeG+HnY7HPqspzskNqpykjbe0qwtDSusZ2Q4Y+sqmRakt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.352.0/index.min.mjs": "sha384-I3Ben+Oy6X/gQLrUynpmeG+HnY7HPqspzskNqpykjbe0qwtDSusZ2Q4Y+sqmRakt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.352.0/LICENSE
```

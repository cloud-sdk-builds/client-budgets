...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B2SZRLhWE77dEYAzkzOxBuyXXpfuBl68WfElKF2DoWt2NyATgLq+L5G9Kdkq4PpW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.796.0/index.min.mjs": "sha384-B2SZRLhWE77dEYAzkzOxBuyXXpfuBl68WfElKF2DoWt2NyATgLq+L5G9Kdkq4PpW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.796.0/LICENSE
```

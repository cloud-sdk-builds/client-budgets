...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EaLOKcF+SXCDpjUl6gJ+tkyZIvtgWgZ4Yj0BRzrfmDQW86vgPBIfuv6sPWoWDIUP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.193.0/index.min.mjs": "sha384-EaLOKcF+SXCDpjUl6gJ+tkyZIvtgWgZ4Yj0BRzrfmDQW86vgPBIfuv6sPWoWDIUP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.193.0/LICENSE
```

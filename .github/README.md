...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ivyT3OJFYO9ilvL5HofBeWFOO/ieO8/8Vfl3Aj93Zs2adOJbsfEqaH8kQxcKUK7r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.888.0/index.min.mjs": "sha384-ivyT3OJFYO9ilvL5HofBeWFOO/ieO8/8Vfl3Aj93Zs2adOJbsfEqaH8kQxcKUK7r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.888.0/LICENSE
```

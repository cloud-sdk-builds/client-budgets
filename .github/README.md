...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XhaXGXdDRcUKgukMj2S+MPYtc/0xg+qmzJJcIVDRSGaQgmynG51Bnj286vGLbbzj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.234.0/index.min.mjs": "sha384-XhaXGXdDRcUKgukMj2S+MPYtc/0xg+qmzJJcIVDRSGaQgmynG51Bnj286vGLbbzj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.234.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ouPu/Ql34XWIveQghPJl7xA6G0z1/IAleeeREeXr8ExoT/kreAjh8IWYxL7a4RwQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.948.0/index.min.mjs": "sha384-ouPu/Ql34XWIveQghPJl7xA6G0z1/IAleeeREeXr8ExoT/kreAjh8IWYxL7a4RwQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.948.0/LICENSE
```

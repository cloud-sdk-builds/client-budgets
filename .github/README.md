...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Or5/VoKufU4MOUSrTHgin8pcneqxaNEpN+p0a+c050AaxOeNks/2dKXWGkpGjZ6J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.862.0/index.min.mjs": "sha384-Or5/VoKufU4MOUSrTHgin8pcneqxaNEpN+p0a+c050AaxOeNks/2dKXWGkpGjZ6J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.862.0/LICENSE
```

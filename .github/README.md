...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tl3Q1fv8DOUoslHQAgYzYik3qf4ZodguWZ/heQ0P++Nbp7mKevoctgHHxdRT+FNj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.957.0/index.min.mjs": "sha384-tl3Q1fv8DOUoslHQAgYzYik3qf4ZodguWZ/heQ0P++Nbp7mKevoctgHHxdRT+FNj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.957.0/LICENSE
```

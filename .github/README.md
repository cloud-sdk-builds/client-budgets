...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-6kAmeRbuiSxQoDkj3bjfKUKTUbNaho3llAeuB0JmtK0iblKxxbyESpUx/mi/5kRV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.8.1/index.min.mjs": "sha384-6kAmeRbuiSxQoDkj3bjfKUKTUbNaho3llAeuB0JmtK0iblKxxbyESpUx/mi/5kRV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.8.1/LICENSE
```

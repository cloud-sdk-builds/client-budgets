...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0qJgEFcoJysgFqKP36qGFnbDc0k14JvEIoY1HPFUOLVT36oun2eG1dkkF9JEAtOq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.196.0/index.min.mjs": "sha384-0qJgEFcoJysgFqKP36qGFnbDc0k14JvEIoY1HPFUOLVT36oun2eG1dkkF9JEAtOq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.196.0/LICENSE
```

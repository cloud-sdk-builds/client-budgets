...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4gzesJFwtcLmaGl+gLIy4nsjLlOQuaW+oetURBBuzy393jMnDXaNrfPPRZ96Iatm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.507.0/index.min.mjs": "sha384-4gzesJFwtcLmaGl+gLIy4nsjLlOQuaW+oetURBBuzy393jMnDXaNrfPPRZ96Iatm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.507.0/LICENSE
```

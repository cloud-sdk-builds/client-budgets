...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cOUSBhRwHtW256wJExDgHPKx7SV8l+MLPpkNTKL50x4rN4KSjDAxRte/g1/CKgNR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.17.0/index.min.mjs": "sha384-cOUSBhRwHtW256wJExDgHPKx7SV8l+MLPpkNTKL50x4rN4KSjDAxRte/g1/CKgNR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.17.0/LICENSE
```

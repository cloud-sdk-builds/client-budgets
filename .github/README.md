...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ybDJoYB4IhqHAY8QN50j5EkK0LB/edCS+slY8kx6kOoIzX2FW5ZSZSbNxXCTnOAy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.436.0/index.min.mjs": "sha384-ybDJoYB4IhqHAY8QN50j5EkK0LB/edCS+slY8kx6kOoIzX2FW5ZSZSbNxXCTnOAy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.436.0/LICENSE
```

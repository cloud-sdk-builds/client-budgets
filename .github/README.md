...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c68/nWil5N73BGfQaBtK7F5+0dWA235MvK8Suk0obgGGVlPZxo/wvzrukLUyendL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.654.0/index.min.mjs": "sha384-c68/nWil5N73BGfQaBtK7F5+0dWA235MvK8Suk0obgGGVlPZxo/wvzrukLUyendL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.654.0/LICENSE
```

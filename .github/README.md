...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MGawUA/dHiyYQJJVhJgZcHotJ77+9e6PGRKyMqJeb1CJiHaXie6xA0/O2U1YJW7z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.583.0/index.min.mjs": "sha384-MGawUA/dHiyYQJJVhJgZcHotJ77+9e6PGRKyMqJeb1CJiHaXie6xA0/O2U1YJW7z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.583.0/LICENSE
```

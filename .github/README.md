...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-05TC/UyonxSYDC1M1L6ztevANz+VnozMcakQzu5u2YOE5LhV8LypUvc3RVQDNtsh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.100.0/index.min.mjs": "sha384-05TC/UyonxSYDC1M1L6ztevANz+VnozMcakQzu5u2YOE5LhV8LypUvc3RVQDNtsh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.100.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NqdQCRgiGGtlK1F2KhstDcYcIqEDdS3n2qrZkUYnwRSSxK+kk7wrGqDK+QCOSxN+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.916.0/index.min.mjs": "sha384-NqdQCRgiGGtlK1F2KhstDcYcIqEDdS3n2qrZkUYnwRSSxK+kk7wrGqDK+QCOSxN+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.916.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hNO6Jop6anIxgsbaEUma/nmW3kTtGj9Wtx/VGalJ0/Pc2Iih9tMyEN/Gimht5RH9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.484.0/index.min.mjs": "sha384-hNO6Jop6anIxgsbaEUma/nmW3kTtGj9Wtx/VGalJ0/Pc2Iih9tMyEN/Gimht5RH9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.484.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rp4m6r/dEOGIitLKkKUlsbpW0BEP1T2iG7p+PHlkEDulf7+AAJ18GUrdG1As1GcL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.281.0/index.min.mjs": "sha384-Rp4m6r/dEOGIitLKkKUlsbpW0BEP1T2iG7p+PHlkEDulf7+AAJ18GUrdG1As1GcL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.281.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3Img4z2LeojC35lQMh4+6olvTCEgiN9xleswrgqsaVkBYcL7zWzm42NMo8kN48Sj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.94.0/index.min.mjs": "sha384-3Img4z2LeojC35lQMh4+6olvTCEgiN9xleswrgqsaVkBYcL7zWzm42NMo8kN48Sj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.94.0/LICENSE
```

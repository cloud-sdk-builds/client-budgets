...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-oYgqBH2fPyX8cBZUQIa9UDALYjLoC79yZLaUlJni7PQGvfhAz2GjlaYKpSYVWw2d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.4.1/index.min.mjs": "sha384-oYgqBH2fPyX8cBZUQIa9UDALYjLoC79yZLaUlJni7PQGvfhAz2GjlaYKpSYVWw2d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.4.1/LICENSE
```

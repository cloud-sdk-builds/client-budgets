...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TxHr0hm8nTOjaxocp4XwdUbVROlzac3R0/Jwbw/Ary5Di0PQda+abPHM08fX3WNn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.734.0/index.min.mjs": "sha384-TxHr0hm8nTOjaxocp4XwdUbVROlzac3R0/Jwbw/Ary5Di0PQda+abPHM08fX3WNn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.734.0/LICENSE
```

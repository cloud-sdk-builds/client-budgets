...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yy5skuLkBO9YyG3qy1pE3CfhdFrloFWEYbs7UnEKhMeqxnjxBHS/5qFf7ZKm9a+4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.996.0/index.min.mjs": "sha384-yy5skuLkBO9YyG3qy1pE3CfhdFrloFWEYbs7UnEKhMeqxnjxBHS/5qFf7ZKm9a+4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.996.0/LICENSE
```

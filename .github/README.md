...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kGuiH28i7wGatPRPgH713loDLPA8Wveg2x1MCNi7nPKQjYe6jjqcrezq9LLNp56n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.678.0/index.min.mjs": "sha384-kGuiH28i7wGatPRPgH713loDLPA8Wveg2x1MCNi7nPKQjYe6jjqcrezq9LLNp56n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.678.0/LICENSE
```

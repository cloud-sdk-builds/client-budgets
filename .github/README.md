...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fWY23Atvr3TubsyiBzrtRYBq0HLH5n32w6BLZFaeXXTR5JNzLLN2VpZrRioq/mpA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.4.0/index.min.mjs": "sha384-fWY23Atvr3TubsyiBzrtRYBq0HLH5n32w6BLZFaeXXTR5JNzLLN2VpZrRioq/mpA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.4.0/LICENSE
```

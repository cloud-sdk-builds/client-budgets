...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0/1zOGNsStDkQaM5S2AP2V8NowQktsHjQSCfNidf9zAu7eyJ51CfRniDGciW0NVn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.741.0/index.min.mjs": "sha384-0/1zOGNsStDkQaM5S2AP2V8NowQktsHjQSCfNidf9zAu7eyJ51CfRniDGciW0NVn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.741.0/LICENSE
```

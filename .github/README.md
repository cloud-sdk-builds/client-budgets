...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-I4OYak/owmkyhEcpqZo6pawhu+JyRmzyVhuqVNGbv2Unx2PfGAzi7IAutJGeed/t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.347.1/index.min.mjs": "sha384-I4OYak/owmkyhEcpqZo6pawhu+JyRmzyVhuqVNGbv2Unx2PfGAzi7IAutJGeed/t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.347.1/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DhOE4nX3wA2JWeFUTOvTomi3RRsCBbA4r6+AsudQ6ywSXX3Fckgt2XYgC37RkBvH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.209.0/index.min.mjs": "sha384-DhOE4nX3wA2JWeFUTOvTomi3RRsCBbA4r6+AsudQ6ywSXX3Fckgt2XYgC37RkBvH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.209.0/LICENSE
```

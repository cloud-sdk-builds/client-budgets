...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z4dgvSEwBIhd4BPll4VIO2Xp4+38/39JFweFwTIEe9pNYE++m9R1eV63PoTPMkE+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.51.0/index.min.mjs": "sha384-Z4dgvSEwBIhd4BPll4VIO2Xp4+38/39JFweFwTIEe9pNYE++m9R1eV63PoTPMkE+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.51.0/LICENSE
```

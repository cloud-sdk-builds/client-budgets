...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1ZYhoaxLsiN+cfnjgD+Zj+f52oYmrBzmvVXiwKwIg4J0Lk+ayoQAiQxvwUggmSgP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.723.0/index.min.mjs": "sha384-1ZYhoaxLsiN+cfnjgD+Zj+f52oYmrBzmvVXiwKwIg4J0Lk+ayoQAiQxvwUggmSgP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.723.0/LICENSE
```

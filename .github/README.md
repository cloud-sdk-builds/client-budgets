...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-id9RE5YDgVI8l2At0haXIoRGLp18h+fcYAqQRILThyou14vz5k8Eumgx1SFpm7P5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.687.0/index.min.mjs": "sha384-id9RE5YDgVI8l2At0haXIoRGLp18h+fcYAqQRILThyou14vz5k8Eumgx1SFpm7P5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.687.0/LICENSE
```

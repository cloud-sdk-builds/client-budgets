...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3npjCne8cpIRwGnc6au8sFIvxLfwWpQrErbemst6/IXYRRVhkwQpiAjR737uNJ4g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.338.0/index.min.mjs": "sha384-3npjCne8cpIRwGnc6au8sFIvxLfwWpQrErbemst6/IXYRRVhkwQpiAjR737uNJ4g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.338.0/LICENSE
```

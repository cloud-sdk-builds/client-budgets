...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nTAQWaR+2YiCS24VB7d9RBHDGEh5cN8gsiZP5Yc8W+1qGRiA1qCQ+fLzy7Lis8PO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.565.0/index.min.mjs": "sha384-nTAQWaR+2YiCS24VB7d9RBHDGEh5cN8gsiZP5Yc8W+1qGRiA1qCQ+fLzy7Lis8PO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.565.0/LICENSE
```

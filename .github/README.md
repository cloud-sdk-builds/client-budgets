...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fDQZdvk/5+e9lxkyzhZbTFRc+vsaGAVKr4RgUq9Qg6TJBRf6Q0SunzJXvroidnnW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.28.0/index.min.mjs": "sha384-fDQZdvk/5+e9lxkyzhZbTFRc+vsaGAVKr4RgUq9Qg6TJBRf6Q0SunzJXvroidnnW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.28.0/LICENSE
```

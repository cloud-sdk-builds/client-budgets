...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-CBU+uRkQebIYyvdIEVRAY0UAvpmS1Nt5GPZByV9XG/ZeAnezITsKZaUJvATek3vr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.503.1/index.min.mjs": "sha384-CBU+uRkQebIYyvdIEVRAY0UAvpmS1Nt5GPZByV9XG/ZeAnezITsKZaUJvATek3vr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.503.1/LICENSE
```

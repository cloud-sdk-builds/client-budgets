...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-18p0oBdfU/NaR8ts1dZxv3tdsmRH+AS+eRsOugudM4VjyQ0b55rQommVdnKnAlAY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.50.0/index.min.mjs": "sha384-18p0oBdfU/NaR8ts1dZxv3tdsmRH+AS+eRsOugudM4VjyQ0b55rQommVdnKnAlAY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.50.0/LICENSE
```

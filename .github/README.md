...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-877Y8iX2dO2Q0gdJPDjtiJT1Xq+ZrIjCGJqaTwy1LXQM8qdoihAldBEh1zYQ1Nqj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.162.0/index.min.mjs": "sha384-877Y8iX2dO2Q0gdJPDjtiJT1Xq+ZrIjCGJqaTwy1LXQM8qdoihAldBEh1zYQ1Nqj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.162.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sY3PlttU5DkggELOSdg5VKYNuv6YbmWGeDi/9DC07smgM4gl97qG/iVj2Ag1DNO0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.901.0/index.min.mjs": "sha384-sY3PlttU5DkggELOSdg5VKYNuv6YbmWGeDi/9DC07smgM4gl97qG/iVj2Ag1DNO0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.901.0/LICENSE
```

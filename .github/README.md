...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FCPCxx+dm9oFjOxcE29Fsz/dQJzKCmIqRG+MiNx2DqkJ560Fd5yMZN9D4NO4sA+G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.19.0/index.min.mjs": "sha384-FCPCxx+dm9oFjOxcE29Fsz/dQJzKCmIqRG+MiNx2DqkJ560Fd5yMZN9D4NO4sA+G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.19.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tMvKvn38mjDtIAT8CgtFmY0qFG9Ihvxjvr2lFVgdvaDQsE+8qyqwxJwrjr34P12M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.210.0/index.min.mjs": "sha384-tMvKvn38mjDtIAT8CgtFmY0qFG9Ihvxjvr2lFVgdvaDQsE+8qyqwxJwrjr34P12M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.210.0/LICENSE
```

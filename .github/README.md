...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/CqV4bgAFtQkFc2za9cE/69o3VjidmZZQWoFGpTMzti3Az8HtMgNld/RiHohfoWg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.428.0/index.min.mjs": "sha384-/CqV4bgAFtQkFc2za9cE/69o3VjidmZZQWoFGpTMzti3Az8HtMgNld/RiHohfoWg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.428.0/LICENSE
```

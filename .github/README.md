...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yIiOI+eJ/cXtulNa62G5XrWIG5uV1znh+i2nDqvWVKQEOwmsViEtOseFGsb+q3g4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.357.0/index.min.mjs": "sha384-yIiOI+eJ/cXtulNa62G5XrWIG5uV1znh+i2nDqvWVKQEOwmsViEtOseFGsb+q3g4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.357.0/LICENSE
```

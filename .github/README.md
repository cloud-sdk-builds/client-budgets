...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-75/C32boospbuzyRN5ufhqLcLo1BnUpcGXyBNUnWf2nBXv8BiIsbwqxuguqjwkEg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.668.0/index.min.mjs": "sha384-75/C32boospbuzyRN5ufhqLcLo1BnUpcGXyBNUnWf2nBXv8BiIsbwqxuguqjwkEg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.668.0/LICENSE
```

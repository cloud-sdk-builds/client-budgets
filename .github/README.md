...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CP/DWUn56G+kV2zZ2SK1PufXrDUu/EhJe4ai2My+Qp4vbkzERd18Ai34uKbYffmG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.886.0/index.min.mjs": "sha384-CP/DWUn56G+kV2zZ2SK1PufXrDUu/EhJe4ai2My+Qp4vbkzERd18Ai34uKbYffmG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.886.0/LICENSE
```

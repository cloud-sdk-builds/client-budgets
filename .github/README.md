...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mClaaTMm5Bb2vsegpr+oKGtEBwgM+UGkgqkDMpHMYIqaExPrgacnk/T/L2hRFJU2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.326.0/index.min.mjs": "sha384-mClaaTMm5Bb2vsegpr+oKGtEBwgM+UGkgqkDMpHMYIqaExPrgacnk/T/L2hRFJU2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.326.0/LICENSE
```

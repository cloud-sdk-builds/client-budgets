...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Obnqpff6tua36xPSczgXtpGgfegyKC/AGrfp4j3d0Xlv9ptCqObmNtJ3VNsW9uwq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.946.0/index.min.mjs": "sha384-Obnqpff6tua36xPSczgXtpGgfegyKC/AGrfp4j3d0Xlv9ptCqObmNtJ3VNsW9uwq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.946.0/LICENSE
```

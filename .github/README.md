...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qS24QZbx4Ud786jrJM1iqAwaTgOba+mxOJDaf3ATq3L5k3icl3KqcDvrpEOqg6D/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.712.0/index.min.mjs": "sha384-qS24QZbx4Ud786jrJM1iqAwaTgOba+mxOJDaf3ATq3L5k3icl3KqcDvrpEOqg6D/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.712.0/LICENSE
```

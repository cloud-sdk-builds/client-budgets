...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m/jPwD8MjTSQofo+khgWD6sj5wlcy/Zgm82n810PYSJwqhdAsD0HCyOBKDI0bcik
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.984.0/index.min.mjs": "sha384-m/jPwD8MjTSQofo+khgWD6sj5wlcy/Zgm82n810PYSJwqhdAsD0HCyOBKDI0bcik"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.984.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/gcaMjfpExkIXJ2RDNGEy66AGHzBnuyCLc3f9+SAsccaml6gc1vRWdOX+9vwB66Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.261.0/index.min.mjs": "sha384-/gcaMjfpExkIXJ2RDNGEy66AGHzBnuyCLc3f9+SAsccaml6gc1vRWdOX+9vwB66Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.261.0/LICENSE
```

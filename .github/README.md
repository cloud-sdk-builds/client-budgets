...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B/uM7b05DBFZnHokMnF1HoYhDfv+/f9xHaOqD9UWuLcvYKRo6YuXt0CijeM6j5fO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.382.0/index.min.mjs": "sha384-B/uM7b05DBFZnHokMnF1HoYhDfv+/f9xHaOqD9UWuLcvYKRo6YuXt0CijeM6j5fO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.382.0/LICENSE
```

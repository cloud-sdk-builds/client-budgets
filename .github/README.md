...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wBSpBm8yAQ4Dyb7wHycul/6EssEW7Vt+QXU32aHEJquH9JRePY9dBzFCvxUehVA+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.863.0/index.min.mjs": "sha384-wBSpBm8yAQ4Dyb7wHycul/6EssEW7Vt+QXU32aHEJquH9JRePY9dBzFCvxUehVA+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.863.0/LICENSE
```

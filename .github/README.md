...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rvZJroHgMR66W4jD+y7vU+qRwoCaVBzeLKJYDlKGI+klxKjqgVaNA2SonZUD/3Fa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.968.0/index.min.mjs": "sha384-rvZJroHgMR66W4jD+y7vU+qRwoCaVBzeLKJYDlKGI+klxKjqgVaNA2SonZUD/3Fa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.968.0/LICENSE
```

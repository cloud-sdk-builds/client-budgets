...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ma3le9GvfV9YWh0fdFhnEP6WeM+kbG+HjcwTNOujIjD56h6Jqgl6V8pLGXXIPF+z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.461.0/index.min.mjs": "sha384-Ma3le9GvfV9YWh0fdFhnEP6WeM+kbG+HjcwTNOujIjD56h6Jqgl6V8pLGXXIPF+z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.461.0/LICENSE
```

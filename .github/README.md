...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FqpD5fHkUzieewui4E6DDmN9A/x0WrujzJGXQqnzFjx2uDWaQfmT33sE7tC2qpzq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.159.0/index.min.mjs": "sha384-FqpD5fHkUzieewui4E6DDmN9A/x0WrujzJGXQqnzFjx2uDWaQfmT33sE7tC2qpzq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.159.0/LICENSE
```

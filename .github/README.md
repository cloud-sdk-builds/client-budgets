...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HuGRc0b4BIK4UmgIUHdeQHfc3P+7lCnhe/KOejG62cmTGmyPMbo3FgZ4+Rhz+9Cc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.997.0/index.min.mjs": "sha384-HuGRc0b4BIK4UmgIUHdeQHfc3P+7lCnhe/KOejG62cmTGmyPMbo3FgZ4+Rhz+9Cc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.997.0/LICENSE
```

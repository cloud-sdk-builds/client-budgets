...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RoI3bwGRIH1tOTSZXK9M4jsNr/j/TPg2uxwLYSiP31O3zuT6J/6DWhEBj5eu0MKx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.588.0/index.min.mjs": "sha384-RoI3bwGRIH1tOTSZXK9M4jsNr/j/TPg2uxwLYSiP31O3zuT6J/6DWhEBj5eu0MKx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.588.0/LICENSE
```

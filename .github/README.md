...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nkeikwv2/ELQPCLZJU/7UOaj1AAXgE4tjOAKtl3/H4GHUg0N0+9aercOmv+wr9dJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.716.0/index.min.mjs": "sha384-nkeikwv2/ELQPCLZJU/7UOaj1AAXgE4tjOAKtl3/H4GHUg0N0+9aercOmv+wr9dJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.716.0/LICENSE
```

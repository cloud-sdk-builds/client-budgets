...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l70IVDWbAsQklq4qkEp1MVococEDv610GbLxOU91Wogxg0elMGGDL28cY+Tb/gXx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.954.0/index.min.mjs": "sha384-l70IVDWbAsQklq4qkEp1MVococEDv610GbLxOU91Wogxg0elMGGDL28cY+Tb/gXx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.954.0/LICENSE
```

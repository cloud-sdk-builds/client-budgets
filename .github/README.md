...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.715.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.715.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-REm1gL1VwvLocgY3veriLAUJ0eilNhyRFF0PJ+/FVbgiJxe9nlTh96lr1Ey+WVTR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.715.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.715.0/index.min.mjs": "sha384-REm1gL1VwvLocgY3veriLAUJ0eilNhyRFF0PJ+/FVbgiJxe9nlTh96lr1Ey+WVTR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.715.0/LICENSE
```

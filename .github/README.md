...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qvx1zJST5A1Al4Sjv/eSekHtLe1W8OpgXSGnd/WHy+mx/bjwv8OBsJ/IHf1d0Sj9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.32.0/index.min.mjs": "sha384-qvx1zJST5A1Al4Sjv/eSekHtLe1W8OpgXSGnd/WHy+mx/bjwv8OBsJ/IHf1d0Sj9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.32.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F9G1kKobYU75kZ/oJ5wKzSgwI+pIc+8TeZ6LIQXGlYkQQdw+lO8MAsLLcq7wih8d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.256.0/index.min.mjs": "sha384-F9G1kKobYU75kZ/oJ5wKzSgwI+pIc+8TeZ6LIQXGlYkQQdw+lO8MAsLLcq7wih8d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.256.0/LICENSE
```

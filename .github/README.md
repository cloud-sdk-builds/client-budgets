...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DJRigX2EWsMkZgj2VYxVzJ1VDZWve7mIzXRK9ZrgAMydprGVjnBV6T3QVSfb+Dc9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.876.0/index.min.mjs": "sha384-DJRigX2EWsMkZgj2VYxVzJ1VDZWve7mIzXRK9ZrgAMydprGVjnBV6T3QVSfb+Dc9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.876.0/LICENSE
```

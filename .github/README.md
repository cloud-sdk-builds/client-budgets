...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-83M/D/eXKSbs7BgZutYDAoC0eduADbmYmDqsg3qP8ZVxrsiRWwWsmsmN8C5Nh5eo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.777.0/index.min.mjs": "sha384-83M/D/eXKSbs7BgZutYDAoC0eduADbmYmDqsg3qP8ZVxrsiRWwWsmsmN8C5Nh5eo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.777.0/LICENSE
```

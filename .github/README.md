...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nlsFFQYnfEufIxV9+9zjbLNRqSXXLkbIqgkD6GA636nWXSjeG1cZDYCnzd6m7DAl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.891.0/index.min.mjs": "sha384-nlsFFQYnfEufIxV9+9zjbLNRqSXXLkbIqgkD6GA636nWXSjeG1cZDYCnzd6m7DAl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.891.0/LICENSE
```

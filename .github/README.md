...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KUHowyx1L8eTA8h7YVeGHUqbhpNu4kQj5XIoE8U6hqXKSg4EtRFmArL0RYIuzoYN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.109.0/index.min.mjs": "sha384-KUHowyx1L8eTA8h7YVeGHUqbhpNu4kQj5XIoE8U6hqXKSg4EtRFmArL0RYIuzoYN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.109.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gwao3ujpRXPV8pXwcU+FizxIoIZxqN9NjvEOgzLCyVRnfOiM0hrT1npjpFnNoM41
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.385.0/index.min.mjs": "sha384-gwao3ujpRXPV8pXwcU+FizxIoIZxqN9NjvEOgzLCyVRnfOiM0hrT1npjpFnNoM41"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.385.0/LICENSE
```

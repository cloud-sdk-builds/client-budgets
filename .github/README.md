...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wxpAIZTqV5cDuPEcVqTtq2zR5RVomOrS3jWzv3GbUX66TVqWINR5JnryQx3QLa2E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.170.0/index.min.mjs": "sha384-wxpAIZTqV5cDuPEcVqTtq2zR5RVomOrS3jWzv3GbUX66TVqWINR5JnryQx3QLa2E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.170.0/LICENSE
```

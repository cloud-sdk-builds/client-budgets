...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZkTUwY29OidCdAm6xE4E5pJHkx0ejhjU3+Vbar9a2+PEiyWk7qGuNwc5xfMvOLg3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.554.0/index.min.mjs": "sha384-ZkTUwY29OidCdAm6xE4E5pJHkx0ejhjU3+Vbar9a2+PEiyWk7qGuNwc5xfMvOLg3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.554.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+IkFYafn/Fr/W94uN0D5ZUgGZQK6KwioisvPD5iYYO5zoGas/5qMqZhLdMcYneSX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.913.0/index.min.mjs": "sha384-+IkFYafn/Fr/W94uN0D5ZUgGZQK6KwioisvPD5iYYO5zoGas/5qMqZhLdMcYneSX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.913.0/LICENSE
```

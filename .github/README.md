...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/QX62noiT5Uc9ZskUA8/1gpsVYM0ynzyZCC++zkvhbfTkKOqt1LhyeBscIS6HdJC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.41.0/index.min.mjs": "sha384-/QX62noiT5Uc9ZskUA8/1gpsVYM0ynzyZCC++zkvhbfTkKOqt1LhyeBscIS6HdJC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.41.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cnV+Eb4v8+1JrcRkjeADuVuGUh3BK962XvvE0BzHxkPIjtUBgIGRBymepWysD7oR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.693.0/index.min.mjs": "sha384-cnV+Eb4v8+1JrcRkjeADuVuGUh3BK962XvvE0BzHxkPIjtUBgIGRBymepWysD7oR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.693.0/LICENSE
```

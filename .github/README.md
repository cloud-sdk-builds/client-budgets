...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HvY4iZLU+71NQWYKHJxivVqqHfcCnr6Fil0j1davI+a4NS5U4j3UF40Yyl0V1gcL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.953.0/index.min.mjs": "sha384-HvY4iZLU+71NQWYKHJxivVqqHfcCnr6Fil0j1davI+a4NS5U4j3UF40Yyl0V1gcL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.953.0/LICENSE
```

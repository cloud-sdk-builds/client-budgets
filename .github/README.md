...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r32+5BGiuBYsxlKnwg0dSAQDQjv4UTkDXmTQseD/wq3JSJP+s9jd0OnsMOPIr+f7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.74.0/index.min.mjs": "sha384-r32+5BGiuBYsxlKnwg0dSAQDQjv4UTkDXmTQseD/wq3JSJP+s9jd0OnsMOPIr+f7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.74.0/LICENSE
```

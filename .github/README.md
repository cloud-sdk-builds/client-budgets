...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w1chRlpQklBXj1XDGmwBwq635oe+AesTueIKQzcNRSvG9ee/lDltKZ2Gtuaiw3En
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.276.0/index.min.mjs": "sha384-w1chRlpQklBXj1XDGmwBwq635oe+AesTueIKQzcNRSvG9ee/lDltKZ2Gtuaiw3En"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.276.0/LICENSE
```

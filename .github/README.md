...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7czvBj9dtHENlKvvFONdHjhzU0pwmqO19LfVO8vho4RkAVxDxhU5HgO+mx0EIz9R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.920.0/index.min.mjs": "sha384-7czvBj9dtHENlKvvFONdHjhzU0pwmqO19LfVO8vho4RkAVxDxhU5HgO+mx0EIz9R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.920.0/LICENSE
```

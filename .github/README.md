...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-2KuHNlz2TcOGhSnLltddLZnFXDB5iWMWvtAHz9iE2+wk0mRFqwtOmiGpJAE/61+M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.379.1/index.min.mjs": "sha384-2KuHNlz2TcOGhSnLltddLZnFXDB5iWMWvtAHz9iE2+wk0mRFqwtOmiGpJAE/61+M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.379.1/LICENSE
```

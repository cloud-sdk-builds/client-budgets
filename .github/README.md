...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vG9rX4F6MRKdW28UC0ftcGXTdOe/WMiMWdMM5V7A/em7DPzOieNF80eYudxUkLZJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.229.0/index.min.mjs": "sha384-vG9rX4F6MRKdW28UC0ftcGXTdOe/WMiMWdMM5V7A/em7DPzOieNF80eYudxUkLZJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.229.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mjbv4GPWAeFvgruPnnvr7spnZpDVkl1kjX7qMpX+4oobNRQrzeGOfUBiFXda8wXN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.438.0/index.min.mjs": "sha384-Mjbv4GPWAeFvgruPnnvr7spnZpDVkl1kjX7qMpX+4oobNRQrzeGOfUBiFXda8wXN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.438.0/LICENSE
```

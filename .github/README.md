...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aLvJHotA05xL/JX+zBJeRN9GmDNpSOw6MExopBCN6QrLetsMgEQ787cUbAysMWwk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.835.0/index.min.mjs": "sha384-aLvJHotA05xL/JX+zBJeRN9GmDNpSOw6MExopBCN6QrLetsMgEQ787cUbAysMWwk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.835.0/LICENSE
```

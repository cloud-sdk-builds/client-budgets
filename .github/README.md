...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qMSdsjCy7eNTyCKjMLUt/9Gm4HhVBdIEUYgLMGYvDNKZS0Pp0YdRksnit3Ouhgmo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.613.0/index.min.mjs": "sha384-qMSdsjCy7eNTyCKjMLUt/9Gm4HhVBdIEUYgLMGYvDNKZS0Pp0YdRksnit3Ouhgmo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.613.0/LICENSE
```

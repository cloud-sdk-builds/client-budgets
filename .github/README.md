...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8px5jpkgISYxmmCLWYTUMGEd54rDD24XIEUV56ags5WIK2NAykQXaerBG0Q+27xS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.758.0/index.min.mjs": "sha384-8px5jpkgISYxmmCLWYTUMGEd54rDD24XIEUV56ags5WIK2NAykQXaerBG0Q+27xS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.758.0/LICENSE
```

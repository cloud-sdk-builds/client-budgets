...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.437.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.437.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gzNr3XMQQiXsLRwBvINTrFK9oBctilaHt1BBHU3SM7AJKkfrCBFWld4Qf2EjRAYl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.437.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.437.0/index.min.mjs": "sha384-gzNr3XMQQiXsLRwBvINTrFK9oBctilaHt1BBHU3SM7AJKkfrCBFWld4Qf2EjRAYl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.437.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/ENNpohNlr9Ar93irNsVQhkfUy6CcPhNUciNxj9EZLjx9wUiA+3E0LCmfu64Em7+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.893.0/index.min.mjs": "sha384-/ENNpohNlr9Ar93irNsVQhkfUy6CcPhNUciNxj9EZLjx9wUiA+3E0LCmfu64Em7+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.893.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r8YrMrP7S7rNd64X9o4Xv8m00UXFbk2XnNScCKa4vO7WmDubNsNUa2+mLi8MhbZv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.713.0/index.min.mjs": "sha384-r8YrMrP7S7rNd64X9o4Xv8m00UXFbk2XnNScCKa4vO7WmDubNsNUa2+mLi8MhbZv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.713.0/LICENSE
```

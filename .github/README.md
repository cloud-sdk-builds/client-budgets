...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6m3ycJgFU7TF1LCfeLTHsiOIsNIbmowVkBSAUtkbD2tA8uLxlNZlt1N4fCRQx/rN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.965.0/index.min.mjs": "sha384-6m3ycJgFU7TF1LCfeLTHsiOIsNIbmowVkBSAUtkbD2tA8uLxlNZlt1N4fCRQx/rN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.965.0/LICENSE
```

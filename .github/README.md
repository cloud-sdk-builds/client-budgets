...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1038.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1038.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0pItNuGQYj4WfOKXPL35plAm8mHtcw3VJCj/8CdFqTeX8tzjbkKcpFchgyprtEM8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1038.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1038.0/index.min.mjs": "sha384-0pItNuGQYj4WfOKXPL35plAm8mHtcw3VJCj/8CdFqTeX8tzjbkKcpFchgyprtEM8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1038.0/LICENSE
```

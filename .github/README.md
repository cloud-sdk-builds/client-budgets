...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1010.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1010.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u/6dH3gwgJpMZR4MA25PiSpLEzwBesIbh1ne5WiEqnPxpPWkIPFGApZTQ+HSmt+r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1010.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1010.0/index.min.mjs": "sha384-u/6dH3gwgJpMZR4MA25PiSpLEzwBesIbh1ne5WiEqnPxpPWkIPFGApZTQ+HSmt+r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1010.0/LICENSE
```

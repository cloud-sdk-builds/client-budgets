...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gssb48Emc498QyjxS1pntosd0HsMfnlCGV0VmlPXcHdN+Jtf+3mCaBDCd3sdtSr2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.278.0/index.min.mjs": "sha384-Gssb48Emc498QyjxS1pntosd0HsMfnlCGV0VmlPXcHdN+Jtf+3mCaBDCd3sdtSr2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.278.0/LICENSE
```

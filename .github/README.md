...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1028.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1028.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jXm9e3pBO+RbNajs1rWHz4gPdoXx4/XQbuUvtvV+wfC9Nsoyd8/NQpXnUQjeU8gg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1028.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1028.0/index.min.mjs": "sha384-jXm9e3pBO+RbNajs1rWHz4gPdoXx4/XQbuUvtvV+wfC9Nsoyd8/NQpXnUQjeU8gg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1028.0/LICENSE
```

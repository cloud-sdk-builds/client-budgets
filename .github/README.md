...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cIf8prqwPeCDpDarDF3EXWO36qfmGObIb+t/qwMTv0b2XbpPWqLEpot4ibtX9MPL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.577.0/index.min.mjs": "sha384-cIf8prqwPeCDpDarDF3EXWO36qfmGObIb+t/qwMTv0b2XbpPWqLEpot4ibtX9MPL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.577.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MMcHyMKWvyBcWTCfY8H2TGV0Hbak7MLGGOAe/49c9UaPoHt0OyPdONYTw4uFTdPX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.772.0/index.min.mjs": "sha384-MMcHyMKWvyBcWTCfY8H2TGV0Hbak7MLGGOAe/49c9UaPoHt0OyPdONYTw4uFTdPX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.772.0/LICENSE
```

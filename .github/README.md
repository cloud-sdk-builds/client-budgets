...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2rA4RCY+iQe+h/Sf/c4VnhCnSK/x6qLaqe05EkuTui3OFOB95i6cZSGp6haAN7Fx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.344.0/index.min.mjs": "sha384-2rA4RCY+iQe+h/Sf/c4VnhCnSK/x6qLaqe05EkuTui3OFOB95i6cZSGp6haAN7Fx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.344.0/LICENSE
```

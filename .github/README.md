...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CohkKKMFk1eqjniejJawC+Cpa6B/7+Akipe9eQZgtbjfYvNsvbveeAvvcuZzFOnY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.515.0/index.min.mjs": "sha384-CohkKKMFk1eqjniejJawC+Cpa6B/7+Akipe9eQZgtbjfYvNsvbveeAvvcuZzFOnY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.515.0/LICENSE
```

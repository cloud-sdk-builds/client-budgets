...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K2PhPIYJ8+AYA6W94u7UA1AAtNkkDk6v0Srxh+AufP4snNp28M42PwkNf1P9NwdK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.974.0/index.min.mjs": "sha384-K2PhPIYJ8+AYA6W94u7UA1AAtNkkDk6v0Srxh+AufP4snNp28M42PwkNf1P9NwdK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.974.0/LICENSE
```

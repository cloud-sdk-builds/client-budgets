...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-1mgnEcSk3Dti+5O2lrOd0EmfdM+GFosLutmk0z8BuNcp9H7Hnc+ERgv63w4asGcZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.118.1/index.min.mjs": "sha384-1mgnEcSk3Dti+5O2lrOd0EmfdM+GFosLutmk0z8BuNcp9H7Hnc+ERgv63w4asGcZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.118.1/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-WLmkaRxAsZp0WfcjQSABuwwtP6ggUgxNCGO4ZzDh22Lq90GpqWYLS5BK2MVEfHCw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.620.1/index.min.mjs": "sha384-WLmkaRxAsZp0WfcjQSABuwwtP6ggUgxNCGO4ZzDh22Lq90GpqWYLS5BK2MVEfHCw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.620.1/LICENSE
```

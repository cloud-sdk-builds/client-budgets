...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EDFjv96JWR7hPzZ1TgwlEK045xiUFnVMXdmL00e3j4E64zQ5xFNc+mrgsQB+ZqaX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.27.0/index.min.mjs": "sha384-EDFjv96JWR7hPzZ1TgwlEK045xiUFnVMXdmL00e3j4E64zQ5xFNc+mrgsQB+ZqaX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.27.0/LICENSE
```

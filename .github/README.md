...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mUbcZJb2emHpKNaT8A8klln3GZhLtKkciQg3Kg0xSA+GL0EhAriR5KnT5bTOvbUV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.179.0/index.min.mjs": "sha384-mUbcZJb2emHpKNaT8A8klln3GZhLtKkciQg3Kg0xSA+GL0EhAriR5KnT5bTOvbUV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.179.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-txsRJSU4dQDLww2M35S+sMkYu280IRZnI0hm3PtlbkoPj1+JritoPXZ8yjOkkyVQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.622.0/index.min.mjs": "sha384-txsRJSU4dQDLww2M35S+sMkYu280IRZnI0hm3PtlbkoPj1+JritoPXZ8yjOkkyVQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.622.0/LICENSE
```

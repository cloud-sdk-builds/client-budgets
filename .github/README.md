...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZeJSd5m3gea8fWbCy4nZNrxAWwQnKz6t26JYagbc4MFzbuWsLVOgUiLxFGLb3kSo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.621.0/index.min.mjs": "sha384-ZeJSd5m3gea8fWbCy4nZNrxAWwQnKz6t26JYagbc4MFzbuWsLVOgUiLxFGLb3kSo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.621.0/LICENSE
```

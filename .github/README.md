...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C0phv7Oa+I8bW3lyTY9vi/RNGCTtxRQUN/ZK5uMVgqnJTAkbRw/VWuEXGsUEb2am
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.216.0/index.min.mjs": "sha384-C0phv7Oa+I8bW3lyTY9vi/RNGCTtxRQUN/ZK5uMVgqnJTAkbRw/VWuEXGsUEb2am"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.216.0/LICENSE
```

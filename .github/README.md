...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l4mD6oEC6OHQ8bDv8ALgGmPTlrakRfG/IysVjn5FDACyya6AjWuKr36MCn5tg+sz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.315.0/index.min.mjs": "sha384-l4mD6oEC6OHQ8bDv8ALgGmPTlrakRfG/IysVjn5FDACyya6AjWuKr36MCn5tg+sz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.315.0/LICENSE
```

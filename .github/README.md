...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JK+BQZ8Mmz9uLDq7sTAHNho12EUl0yQMjEPf/BOeVW152pWkh+1amgfCHmpCUhtG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.298.0/index.min.mjs": "sha384-JK+BQZ8Mmz9uLDq7sTAHNho12EUl0yQMjEPf/BOeVW152pWkh+1amgfCHmpCUhtG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.298.0/LICENSE
```

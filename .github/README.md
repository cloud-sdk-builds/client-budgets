...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MFON5H+6RZL5C/BjDhbxjQPUDKeXJKlBZY2vatcYucHCHVXgiw0c5xHr0PRXKuip
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.969.0/index.min.mjs": "sha384-MFON5H+6RZL5C/BjDhbxjQPUDKeXJKlBZY2vatcYucHCHVXgiw0c5xHr0PRXKuip"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.969.0/LICENSE
```

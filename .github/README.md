...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hxSI81h76+PKFsd1AhIsNz6emeOiYsplWPenknk7YJkXi03ecMPnaEZ9mG08Vls1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.337.0/index.min.mjs": "sha384-hxSI81h76+PKFsd1AhIsNz6emeOiYsplWPenknk7YJkXi03ecMPnaEZ9mG08Vls1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.337.0/LICENSE
```

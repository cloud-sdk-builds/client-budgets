...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bDMHbHzeVzVE9CpiM1z4mt2UQBE0qaQLnoWjzAE9bbFvJ4g03hJMkZshj1aKhrjW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.76.0/index.min.mjs": "sha384-bDMHbHzeVzVE9CpiM1z4mt2UQBE0qaQLnoWjzAE9bbFvJ4g03hJMkZshj1aKhrjW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.76.0/LICENSE
```

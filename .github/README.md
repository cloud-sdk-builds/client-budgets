...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.110.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0e1aXCpN5hT6+yHgvV5d65ns8uoVNI5wIWY6ix/6OYIGUUwsppfbMOKdjSxoiyGD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.110.0/index.min.mjs": "sha384-0e1aXCpN5hT6+yHgvV5d65ns8uoVNI5wIWY6ix/6OYIGUUwsppfbMOKdjSxoiyGD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.110.0/LICENSE
```

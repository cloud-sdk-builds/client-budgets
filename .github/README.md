...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bA9Hk9ge+EWFIkvLCT1x9vLgLoaUdMgZACw8ZxUaothqpPaS9bILaNUWZqAsMhm0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.992.0/index.min.mjs": "sha384-bA9Hk9ge+EWFIkvLCT1x9vLgLoaUdMgZACw8ZxUaothqpPaS9bILaNUWZqAsMhm0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.992.0/LICENSE
```

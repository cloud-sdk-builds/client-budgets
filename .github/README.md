...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/WAnW0wxvVYB/GU83yM+jN7QdLPu0CD+aJrp+ErguZ/RYXvnZsEYgrWR/b/m4PpB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.81.0/index.min.mjs": "sha384-/WAnW0wxvVYB/GU83yM+jN7QdLPu0CD+aJrp+ErguZ/RYXvnZsEYgrWR/b/m4PpB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.81.0/LICENSE
```

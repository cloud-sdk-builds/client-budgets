...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1001.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1001.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WnitfkLwHjSCMZYWi4FQ+6GmLcj3vpozfXTYZVIzaxTpncWN4JbDJHZOxPBGBc9q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1001.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1001.0/index.min.mjs": "sha384-WnitfkLwHjSCMZYWi4FQ+6GmLcj3vpozfXTYZVIzaxTpncWN4JbDJHZOxPBGBc9q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1001.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xy0BRI4XlPw9JteilYJCRpfMqSJtYFtj6V5QT/aDYQ38A4yq5UK/1+gLExfT6pdK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.914.0/index.min.mjs": "sha384-xy0BRI4XlPw9JteilYJCRpfMqSJtYFtj6V5QT/aDYQ38A4yq5UK/1+gLExfT6pdK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.914.0/LICENSE
```

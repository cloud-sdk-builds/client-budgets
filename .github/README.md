...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nxPLCFuSKkP3s6Tm6Y/7h5609v5tTTaPEVNcFku8JV6b7g2o3daHY7r+6cIMikLT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.423.0/index.min.mjs": "sha384-nxPLCFuSKkP3s6Tm6Y/7h5609v5tTTaPEVNcFku8JV6b7g2o3daHY7r+6cIMikLT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.423.0/LICENSE
```

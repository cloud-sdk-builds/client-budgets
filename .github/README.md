...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.427.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.427.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eTLWLNqTCM9bOPdmYQH5iLyxNA29suXMU1t0pKLnEtJX8ENf4saBxYbqa2GKo167
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.427.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.427.0/index.min.mjs": "sha384-eTLWLNqTCM9bOPdmYQH5iLyxNA29suXMU1t0pKLnEtJX8ENf4saBxYbqa2GKo167"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.427.0/LICENSE
```

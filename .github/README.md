...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yy1KcgbZVgJIQV8H1EW+8VYhWI/tDagqHVMWU902bGubSmJPMluPSHZ+11o8+4TJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.552.0/index.min.mjs": "sha384-yy1KcgbZVgJIQV8H1EW+8VYhWI/tDagqHVMWU902bGubSmJPMluPSHZ+11o8+4TJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.552.0/LICENSE
```

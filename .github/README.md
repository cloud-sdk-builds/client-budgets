...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LsuALjbGJKEIiy4DfXKRPbMk8UjoseqRABeGFkimeA7XPoEk/+6B44rmWzL1P3YD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.549.0/index.min.mjs": "sha384-LsuALjbGJKEIiy4DfXKRPbMk8UjoseqRABeGFkimeA7XPoEk/+6B44rmWzL1P3YD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.549.0/LICENSE
```

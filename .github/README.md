...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rrIShcodWEzRQ7BntED1r049yhNv/0zLxKqkxm2temjl89TZMVh0T9qi0zwAEav7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.121.0/index.min.mjs": "sha384-rrIShcodWEzRQ7BntED1r049yhNv/0zLxKqkxm2temjl89TZMVh0T9qi0zwAEav7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.121.0/LICENSE
```

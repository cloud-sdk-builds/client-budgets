...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.190.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.190.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rJ0+aKBq7gHLTFBP9bdyP2pLhX7neJ44fdxewEN/AZUiXbXExUEJw6tGcKsJl18Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.190.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.190.0/index.min.mjs": "sha384-rJ0+aKBq7gHLTFBP9bdyP2pLhX7neJ44fdxewEN/AZUiXbXExUEJw6tGcKsJl18Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.190.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.195.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.195.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KckkQkdYs8YD+Y9xI1SX9dXNP6QrTFZ3fvuQCucRCLoZ3i+UN4WATnjekqaen8a7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.195.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.195.0/index.min.mjs": "sha384-KckkQkdYs8YD+Y9xI1SX9dXNP6QrTFZ3fvuQCucRCLoZ3i+UN4WATnjekqaen8a7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.195.0/LICENSE
```

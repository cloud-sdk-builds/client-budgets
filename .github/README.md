...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1009.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1009.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sAZjXbz+JKR+W1zBo1CYJbJtth2cvcOnbWGu7AuRuQQiuEry0OySADxeR6COIdcf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1009.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1009.0/index.min.mjs": "sha384-sAZjXbz+JKR+W1zBo1CYJbJtth2cvcOnbWGu7AuRuQQiuEry0OySADxeR6COIdcf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1009.0/LICENSE
```

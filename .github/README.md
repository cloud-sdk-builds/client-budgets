...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aJmZmVd1n9CJoW/82JOCkmRrVntQfCSzwAB0OKsnidvLzzw9IO3069FxUYGidY31
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.259.0/index.min.mjs": "sha384-aJmZmVd1n9CJoW/82JOCkmRrVntQfCSzwAB0OKsnidvLzzw9IO3069FxUYGidY31"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.259.0/LICENSE
```

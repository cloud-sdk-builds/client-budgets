...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QUBRwa+go2Ke7lrrdRCVi8xZ9HXaSGLemVMSLP/UQYBHET13Txc7nRVFljvhwN0r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.808.0/index.min.mjs": "sha384-QUBRwa+go2Ke7lrrdRCVi8xZ9HXaSGLemVMSLP/UQYBHET13Txc7nRVFljvhwN0r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.808.0/LICENSE
```

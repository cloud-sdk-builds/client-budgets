...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LjDfiKlYFvP+6a7wBpHsj0SGZGk5VBDm35VcgzBXZa8SJAjXy92Rdqu7CQBuqm1Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.922.0/index.min.mjs": "sha384-LjDfiKlYFvP+6a7wBpHsj0SGZGk5VBDm35VcgzBXZa8SJAjXy92Rdqu7CQBuqm1Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.922.0/LICENSE
```

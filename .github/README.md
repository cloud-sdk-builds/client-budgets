...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-57FFYwr+GZB0X32FaNFU43vZjaydG5DdmVY3NBJRxCXvNsvYRs6Cy/xREIqT2spG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.42.0/index.min.mjs": "sha384-57FFYwr+GZB0X32FaNFU43vZjaydG5DdmVY3NBJRxCXvNsvYRs6Cy/xREIqT2spG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.42.0/LICENSE
```

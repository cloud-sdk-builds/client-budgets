...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8XwTsqv8c91U0PSa+3NTUt15uq1VqQdLAZkEIkwYNY/LtH3OyuMXm2Lxk+pgalmr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.971.0/index.min.mjs": "sha384-8XwTsqv8c91U0PSa+3NTUt15uq1VqQdLAZkEIkwYNY/LtH3OyuMXm2Lxk+pgalmr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.971.0/LICENSE
```

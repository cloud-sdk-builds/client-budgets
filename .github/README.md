...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jlWS5wu7HLl8Cij82wFEPXY4mFolNGD9dpf5yfPdsVhlfYoFEErPnqP7j4yFDiQC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.299.0/index.min.mjs": "sha384-jlWS5wu7HLl8Cij82wFEPXY4mFolNGD9dpf5yfPdsVhlfYoFEErPnqP7j4yFDiQC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.299.0/LICENSE
```

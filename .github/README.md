...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BpIOn3Jbyq0gOrsy4EH1PIKRbWrQHjhjUeSRFqc5TQnRdlwFYFg72kmY8X0FweMt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.574.0/index.min.mjs": "sha384-BpIOn3Jbyq0gOrsy4EH1PIKRbWrQHjhjUeSRFqc5TQnRdlwFYFg72kmY8X0FweMt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.574.0/LICENSE
```

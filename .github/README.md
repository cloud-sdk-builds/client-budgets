...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-diSaCKYbCfpGEt+RtS4JS7rU0J8o7wXrVyeMcnZsHxCDERqFs1IEP9gCK1MBlhwk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.490.0/index.min.mjs": "sha384-diSaCKYbCfpGEt+RtS4JS7rU0J8o7wXrVyeMcnZsHxCDERqFs1IEP9gCK1MBlhwk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.490.0/LICENSE
```

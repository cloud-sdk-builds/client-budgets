...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NY7+4greHngk3AZwSU5BA4+lV4wghTaf4g6pJDK0dl3Q7VjLjaC7VNuD6rjxXMQ0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.137.0/index.min.mjs": "sha384-NY7+4greHngk3AZwSU5BA4+lV4wghTaf4g6pJDK0dl3Q7VjLjaC7VNuD6rjxXMQ0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.137.0/LICENSE
```

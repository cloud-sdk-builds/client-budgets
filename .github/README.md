...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lMPq73uXLivW5Xm1i+S0VQ2q+XZ1ELg/izbZa1k1xRL/DCjK/9jx8OkXHIB6MUos
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.405.0/index.min.mjs": "sha384-lMPq73uXLivW5Xm1i+S0VQ2q+XZ1ELg/izbZa1k1xRL/DCjK/9jx8OkXHIB6MUos"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.405.0/LICENSE
```

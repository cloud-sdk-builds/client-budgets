...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VkmnpX9T4hxEQiR3KClN8q0JNSqgMT5Ka2Q9cBQF83pH8mC6i7jCfb7W4u/DLivQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1.0/index.min.mjs": "sha384-VkmnpX9T4hxEQiR3KClN8q0JNSqgMT5Ka2Q9cBQF83pH8mC6i7jCfb7W4u/DLivQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1.0/LICENSE
```

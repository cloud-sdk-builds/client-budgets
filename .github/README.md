...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x0kNRydRnsx9MlV9QyGFVLMKt+tYEqEEUSEjseVtfSN/fA0i6XuRSZrAJ+WlTN9H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.413.0/index.min.mjs": "sha384-x0kNRydRnsx9MlV9QyGFVLMKt+tYEqEEUSEjseVtfSN/fA0i6XuRSZrAJ+WlTN9H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.413.0/LICENSE
```

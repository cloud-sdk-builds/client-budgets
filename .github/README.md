...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L3nlV4rKS33+aaNFnhNiKSu+mH2iudIcHzMds596i/WvCMI91HddbT0+DLH9xzpf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.168.0/index.min.mjs": "sha384-L3nlV4rKS33+aaNFnhNiKSu+mH2iudIcHzMds596i/WvCMI91HddbT0+DLH9xzpf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.168.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XKJOu3pj+nUpJxG4BFF7XVeZIux+TkkwG8RCBb+vj2+XQQ8kRMgMpQD8E+nssyXj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.345.0/index.min.mjs": "sha384-XKJOu3pj+nUpJxG4BFF7XVeZIux+TkkwG8RCBb+vj2+XQQ8kRMgMpQD8E+nssyXj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.345.0/LICENSE
```

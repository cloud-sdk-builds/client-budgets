...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JQLFtZ3eYlX56lT9NKHUOrMFCAnRSVc0gOi760uc9CSpZYkut9uBiczgS7WLg57Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.620.0/index.min.mjs": "sha384-JQLFtZ3eYlX56lT9NKHUOrMFCAnRSVc0gOi760uc9CSpZYkut9uBiczgS7WLg57Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.620.0/LICENSE
```

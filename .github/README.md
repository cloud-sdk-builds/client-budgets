...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jK1/93d/Ks2F1SxkKvVKWWuZR+TM1m6tDZNjy2X/8CFDAasS+1NHxyIpyUrFksrm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.600.0/index.min.mjs": "sha384-jK1/93d/Ks2F1SxkKvVKWWuZR+TM1m6tDZNjy2X/8CFDAasS+1NHxyIpyUrFksrm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.600.0/LICENSE
```

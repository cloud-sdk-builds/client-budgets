...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YTAHcRFcE5n1tn+pPyoI4lkUgFi7lTJlLWNkVBrh4vo11ec4xUAsh217m5x40SwV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.35.0/index.min.mjs": "sha384-YTAHcRFcE5n1tn+pPyoI4lkUgFi7lTJlLWNkVBrh4vo11ec4xUAsh217m5x40SwV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.35.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HPDTEIQW+qLh0fKsJ7w2s0y7xqEe5R0sr5medzkQmTcNUu3XKeGnYYPx11AfELut
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.202.0/index.min.mjs": "sha384-HPDTEIQW+qLh0fKsJ7w2s0y7xqEe5R0sr5medzkQmTcNUu3XKeGnYYPx11AfELut"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.202.0/LICENSE
```

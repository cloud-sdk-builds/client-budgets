...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YjOyc8QHwjY2daFX6ScSrd3rSoAED+J96v31AwaIYId0Uim8afUP/0OZqsK7HX8C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.812.0/index.min.mjs": "sha384-YjOyc8QHwjY2daFX6ScSrd3rSoAED+J96v31AwaIYId0Uim8afUP/0OZqsK7HX8C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.812.0/LICENSE
```

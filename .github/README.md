...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.383.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.383.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Md0EDpCQTlIMdybJjhUlYd7CW15usw7j2bxNoXHHf+7LAhmJS1GmdRF1uQPcuv9B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.383.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.383.0/index.min.mjs": "sha384-Md0EDpCQTlIMdybJjhUlYd7CW15usw7j2bxNoXHHf+7LAhmJS1GmdRF1uQPcuv9B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.383.0/LICENSE
```

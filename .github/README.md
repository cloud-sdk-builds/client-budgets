...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-UyvBjSn4pAyv5areMCP++V075YmElhAbVrn//f4n8P22fRQe27K1uNXlC52PavoM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.36.1/index.min.mjs": "sha384-UyvBjSn4pAyv5areMCP++V075YmElhAbVrn//f4n8P22fRQe27K1uNXlC52PavoM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.36.1/LICENSE
```

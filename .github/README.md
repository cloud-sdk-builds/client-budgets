...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JBdzsAr0Wb2PagDcUIXUTR2oj3C3j6bVBt0iLtxiF/Kx1MkigdXl2oGWYM2NSdMD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.24.0/index.min.mjs": "sha384-JBdzsAr0Wb2PagDcUIXUTR2oj3C3j6bVBt0iLtxiF/Kx1MkigdXl2oGWYM2NSdMD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.24.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-rtS/fAB3mNaLn9Swrkr7V6gYexrpEWg0kquksOd5jwWKKRQ4lAgobmM0/Nd3t6Kq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.731.1/index.min.mjs": "sha384-rtS/fAB3mNaLn9Swrkr7V6gYexrpEWg0kquksOd5jwWKKRQ4lAgobmM0/Nd3t6Kq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.731.1/LICENSE
```

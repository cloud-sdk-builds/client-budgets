...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ME2CRTTqOf0p+CsQpolVilEazFmJM2P1IhGt/CogeVo0F5FbxyEi7d0QwiWgmp9m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.596.0/index.min.mjs": "sha384-ME2CRTTqOf0p+CsQpolVilEazFmJM2P1IhGt/CogeVo0F5FbxyEi7d0QwiWgmp9m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.596.0/LICENSE
```

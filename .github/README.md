...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5uhKOd1CXzIyGBbxYI6hij3jG9v9XKLDg81Ap6e5+Qsv/C2yg/wfXp8xgONFoREj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.540.0/index.min.mjs": "sha384-5uhKOd1CXzIyGBbxYI6hij3jG9v9XKLDg81Ap6e5+Qsv/C2yg/wfXp8xgONFoREj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.540.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XfQgJzuKtIXBra0TsQTDGsyT1sHCr0kMw2G4XJ89NCn1pIoniGFW/WDnreeU+yK4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.454.0/index.min.mjs": "sha384-XfQgJzuKtIXBra0TsQTDGsyT1sHCr0kMw2G4XJ89NCn1pIoniGFW/WDnreeU+yK4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.454.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EGlkPYGd9mWfLgNvxM2WIicK2Hq5H/+EL2k4iht3VNeTpD5wydqXTOAKqbMwcth1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.972.0/index.min.mjs": "sha384-EGlkPYGd9mWfLgNvxM2WIicK2Hq5H/+EL2k4iht3VNeTpD5wydqXTOAKqbMwcth1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.972.0/LICENSE
```

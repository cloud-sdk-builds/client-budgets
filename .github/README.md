...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5s8f88xat22oqB//5cm7Jgp9iOUEqCAg0peyFEY05gEVnoGWIuQfkDyVdJINuIoA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.127.0/index.min.mjs": "sha384-5s8f88xat22oqB//5cm7Jgp9iOUEqCAg0peyFEY05gEVnoGWIuQfkDyVdJINuIoA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.127.0/LICENSE
```

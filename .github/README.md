...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9RuyYTn6+rYMFoOf5nI5ek7JcLz7tPfPfPMI61/pdWWIjDZwtIHGk0P4S/25jw3E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.935.0/index.min.mjs": "sha384-9RuyYTn6+rYMFoOf5nI5ek7JcLz7tPfPfPMI61/pdWWIjDZwtIHGk0P4S/25jw3E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.935.0/LICENSE
```

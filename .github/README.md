...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SKYOM1G0XeK/ySLkvrp0GXGuR1TKwDiDWi1980HIIipF8TlEq7tu7+dro5ruFJqU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.882.0/index.min.mjs": "sha384-SKYOM1G0XeK/ySLkvrp0GXGuR1TKwDiDWi1980HIIipF8TlEq7tu7+dro5ruFJqU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.882.0/LICENSE
```

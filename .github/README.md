...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-zOjnoaguriGJ6eOhqVzrP6xgAx3ao5tyLHRqH8sOKwsIoADOS7iLp22+e6IJmMQA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.2/index.min.mjs": "sha384-zOjnoaguriGJ6eOhqVzrP6xgAx3ao5tyLHRqH8sOKwsIoADOS7iLp22+e6IJmMQA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.47.2/LICENSE
```

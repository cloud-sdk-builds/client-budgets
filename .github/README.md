...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g8VQboWDw/bH4GQAUmNtaePgAV5JI0hQsmjP41HHJ3+u/0WqvAegkPQJJDXXMxjL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.650.0/index.min.mjs": "sha384-g8VQboWDw/bH4GQAUmNtaePgAV5JI0hQsmjP41HHJ3+u/0WqvAegkPQJJDXXMxjL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.650.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F/jUSaefZ+IW+WWrmR33qdOxpP6AKd4d7VjQ4/XtDE2LbeK1it8L7sm7YDzeBRsG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.576.0/index.min.mjs": "sha384-F/jUSaefZ+IW+WWrmR33qdOxpP6AKd4d7VjQ4/XtDE2LbeK1it8L7sm7YDzeBRsG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.576.0/LICENSE
```

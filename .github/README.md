...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xNBtEbXYVtnJzja54rsH4fvYhgw0gLKKxUE59sPESlHzCzbSb7YXRb91oTD16Lnq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.358.0/index.min.mjs": "sha384-xNBtEbXYVtnJzja54rsH4fvYhgw0gLKKxUE59sPESlHzCzbSb7YXRb91oTD16Lnq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.358.0/LICENSE
```

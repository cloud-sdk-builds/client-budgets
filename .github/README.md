...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q1DaHBpZZlMQNgVlkNDG11H8c4YibF5CTDDhfoZFWXvJ4zL7D32hiAJSQy4gV6NW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.266.0/index.min.mjs": "sha384-Q1DaHBpZZlMQNgVlkNDG11H8c4YibF5CTDDhfoZFWXvJ4zL7D32hiAJSQy4gV6NW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.266.0/LICENSE
```

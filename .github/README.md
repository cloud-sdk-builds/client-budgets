...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.462.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.462.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K23Bu3Ik2KdsrUoYKh2h4VRu9nrgBn6RTmtd5VSdQS/rGPmZG3Q/Vs1DSiAfb1wa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.462.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.462.0/index.min.mjs": "sha384-K23Bu3Ik2KdsrUoYKh2h4VRu9nrgBn6RTmtd5VSdQS/rGPmZG3Q/Vs1DSiAfb1wa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.462.0/LICENSE
```

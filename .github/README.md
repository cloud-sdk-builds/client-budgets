...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MapIdYVz5qB/TjA5gL8lHDRPwTVcoMupVIFpl6z5J00sm4tclW22FU/1AiLBqnDP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.910.0/index.min.mjs": "sha384-MapIdYVz5qB/TjA5gL8lHDRPwTVcoMupVIFpl6z5J00sm4tclW22FU/1AiLBqnDP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.910.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0EWTbXcMPxn7jKD+e32FKbU1aU7D34JxZWq3g1ITQYLps3TtxeHdHf+WK195M9ML
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.5.0/index.min.mjs": "sha384-0EWTbXcMPxn7jKD+e32FKbU1aU7D34JxZWq3g1ITQYLps3TtxeHdHf+WK195M9ML"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.5.0/LICENSE
```

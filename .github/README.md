...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R894CsaA7B3SahGuC+5FpiMqMq4nD4B69yZ7/p+aADo/Y1F/zOxqLLOBeHSDquoo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.828.0/index.min.mjs": "sha384-R894CsaA7B3SahGuC+5FpiMqMq4nD4B69yZ7/p+aADo/Y1F/zOxqLLOBeHSDquoo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.828.0/LICENSE
```

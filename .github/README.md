...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+OH5r9KHlwwSEBxHGXnzbpbtVzV0Ir2qcnot5CNJqR0PfYef35JTafY8dRo4JohU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.204.0/index.min.mjs": "sha384-+OH5r9KHlwwSEBxHGXnzbpbtVzV0Ir2qcnot5CNJqR0PfYef35JTafY8dRo4JohU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.204.0/LICENSE
```

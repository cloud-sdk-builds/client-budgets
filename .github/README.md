...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.937.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.937.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R4KSZITb97HHuQz9lPaUmicH0zcsvKuztQRrPrLuMLx1FisaA7kyentkoQfVg1ES
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.937.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.937.0/index.min.mjs": "sha384-R4KSZITb97HHuQz9lPaUmicH0zcsvKuztQRrPrLuMLx1FisaA7kyentkoQfVg1ES"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.937.0/LICENSE
```

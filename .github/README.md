...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R0fc4ppz5xyAqpmqegdh8J5ZABQDfEDkwNVWxd5rCTSzw1yY32lKUKNbxzYEYy7L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.470.0/index.min.mjs": "sha384-R0fc4ppz5xyAqpmqegdh8J5ZABQDfEDkwNVWxd5rCTSzw1yY32lKUKNbxzYEYy7L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.470.0/LICENSE
```

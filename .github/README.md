...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pfizaPFpQ0yk1K0DaAm1VRdPd40uIEiyES85y0lqNsPYRMt7DvJ3TwhP0bIBuuSA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.958.0/index.min.mjs": "sha384-pfizaPFpQ0yk1K0DaAm1VRdPd40uIEiyES85y0lqNsPYRMt7DvJ3TwhP0bIBuuSA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.958.0/LICENSE
```

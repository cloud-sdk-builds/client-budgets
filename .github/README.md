...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S5bmfuvQuqkyxhinlZRNbLZ2wb0qHbTw0vaE+AICefO0pBmXYRlDSJ2ospswdSx3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.925.0/index.min.mjs": "sha384-S5bmfuvQuqkyxhinlZRNbLZ2wb0qHbTw0vaE+AICefO0pBmXYRlDSJ2ospswdSx3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.925.0/LICENSE
```

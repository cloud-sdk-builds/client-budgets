...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ClGU2awWWCLkqf4Q73gR/MVLbPweHKzZykH9TnvKuIvdlbnT1IHCBoywZOAu2n5D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.163.0/index.min.mjs": "sha384-ClGU2awWWCLkqf4Q73gR/MVLbPweHKzZykH9TnvKuIvdlbnT1IHCBoywZOAu2n5D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.163.0/LICENSE
```

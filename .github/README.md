...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u8AmCwv6M4WYkxaI33DKGGdPdPjxTlCGdTBdSC0puuKoM+kkqJWQSI28SfBUu7rN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.165.0/index.min.mjs": "sha384-u8AmCwv6M4WYkxaI33DKGGdPdPjxTlCGdTBdSC0puuKoM+kkqJWQSI28SfBUu7rN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.165.0/LICENSE
```

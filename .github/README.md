...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-drZJh5Ic4ImgB1i1a5no8JnBNm79I0dWfTi3r3ruKEiDu7+45fp97NMDBF45DeAM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.567.0/index.min.mjs": "sha384-drZJh5Ic4ImgB1i1a5no8JnBNm79I0dWfTi3r3ruKEiDu7+45fp97NMDBF45DeAM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.567.0/LICENSE
```

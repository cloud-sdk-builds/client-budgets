...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1042.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1042.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IQl7f9O56t2EoOLq6UMQ+vTJj7TdL4dU9WPNjPKBpeGHdsF8H9YYXDbVAji//5h/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1042.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1042.0/index.min.mjs": "sha384-IQl7f9O56t2EoOLq6UMQ+vTJj7TdL4dU9WPNjPKBpeGHdsF8H9YYXDbVAji//5h/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1042.0/LICENSE
```

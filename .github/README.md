...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cxWzQKq24yH1ze2CEBffiN+ZFWzKTsFd7CdyRp9H188MClwftx+UvR8iYAcV4m9x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.887.0/index.min.mjs": "sha384-cxWzQKq24yH1ze2CEBffiN+ZFWzKTsFd7CdyRp9H188MClwftx+UvR8iYAcV4m9x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.887.0/LICENSE
```

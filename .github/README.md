...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Uu/8YHXTw6NnS8I+kSnFjsTI3yzj+nZZ250whUKIEzxnRWxiyZUbY+IB/Q0xJyXc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.624.0/index.min.mjs": "sha384-Uu/8YHXTw6NnS8I+kSnFjsTI3yzj+nZZ250whUKIEzxnRWxiyZUbY+IB/Q0xJyXc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.624.0/LICENSE
```

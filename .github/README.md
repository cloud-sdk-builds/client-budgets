...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XBtsBOJ+JcOIAWkT9spPCY/A76ZwSEpXVqymAJMJ0B4MbZcQI8RhHHGfpueiIq9H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.839.0/index.min.mjs": "sha384-XBtsBOJ+JcOIAWkT9spPCY/A76ZwSEpXVqymAJMJ0B4MbZcQI8RhHHGfpueiIq9H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.839.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AcKuvnk+BC7VPhGOJ2nHppUYfBEg8dDvlPj7ulqd+VTdjF/bJ0ehtWzaEJua3xIZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.477.0/index.min.mjs": "sha384-AcKuvnk+BC7VPhGOJ2nHppUYfBEg8dDvlPj7ulqd+VTdjF/bJ0ehtWzaEJua3xIZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.477.0/LICENSE
```

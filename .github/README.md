...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.571.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.571.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yWGtIoKkmo1Tju4KJT4ONeQ1L0PJsBunPrKAzELEhWm9PZyomU2NavVNYQX+Jpjw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.571.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.571.0/index.min.mjs": "sha384-yWGtIoKkmo1Tju4KJT4ONeQ1L0PJsBunPrKAzELEhWm9PZyomU2NavVNYQX+Jpjw"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.571.0`)
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.571.0/LICENSE
```

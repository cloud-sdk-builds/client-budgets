...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HHYyU/63bpRACld+OXL5PDrsM4xR8uLSNrEyOrbUqZCtyHmLgvElUv+ZJme0Orkt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.15.0/index.min.mjs": "sha384-HHYyU/63bpRACld+OXL5PDrsM4xR8uLSNrEyOrbUqZCtyHmLgvElUv+ZJme0Orkt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.15.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nQr4kxe+L1wzGLD79yGsS5m/+t6FSEcKEC89v1K0tZfR0a2ozS46HTPVtwkkGaII
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.161.0/index.min.mjs": "sha384-nQr4kxe+L1wzGLD79yGsS5m/+t6FSEcKEC89v1K0tZfR0a2ozS46HTPVtwkkGaII"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.161.0/LICENSE
```

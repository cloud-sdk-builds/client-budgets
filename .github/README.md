...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iOyFtbW9yngCjdamkNw1HArNQou7Mh5vREu0MzOxuvOQJZOsuxXzVVoNzQeClI0j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.645.0/index.min.mjs": "sha384-iOyFtbW9yngCjdamkNw1HArNQou7Mh5vREu0MzOxuvOQJZOsuxXzVVoNzQeClI0j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.645.0/LICENSE
```

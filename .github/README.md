...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QJM8KmegTWF1x/2lb5STSax9VGhj2wnGr3FZWsOeq3Bwbrh2oWfLa3YDiB4BKD4t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.359.0/index.min.mjs": "sha384-QJM8KmegTWF1x/2lb5STSax9VGhj2wnGr3FZWsOeq3Bwbrh2oWfLa3YDiB4BKD4t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.359.0/LICENSE
```

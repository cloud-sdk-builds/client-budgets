...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GBaORfTYbJxq0KPU3slyVqljSYA4CkmM+nM8DtdPJD32chPi5gvaGST8F9mJdgkp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.563.0/index.min.mjs": "sha384-GBaORfTYbJxq0KPU3slyVqljSYA4CkmM+nM8DtdPJD32chPi5gvaGST8F9mJdgkp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.563.0/LICENSE
```

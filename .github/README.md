...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4j2jT2w7spKZOKkaj1vD6LwAbN5rId/gp2kh7jSewftcH7REvK6ISUWCOWbzv/pS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.782.0/index.min.mjs": "sha384-4j2jT2w7spKZOKkaj1vD6LwAbN5rId/gp2kh7jSewftcH7REvK6ISUWCOWbzv/pS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.782.0/LICENSE
```

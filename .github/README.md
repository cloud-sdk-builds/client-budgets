...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ITC83WRko0liXwF1ivVZSa8nh3aQ/2+/XLES2QUj6S4eTO25D/zz3i/oObVigKyT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.750.0/index.min.mjs": "sha384-ITC83WRko0liXwF1ivVZSa8nh3aQ/2+/XLES2QUj6S4eTO25D/zz3i/oObVigKyT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.750.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iXUqfHKGa81n2Jd9sb2snO8ZFkdVxHSnKrqBKpgxcIb5pf43kwJcuYN4ZI+RnzAI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.52.0/index.min.mjs": "sha384-iXUqfHKGa81n2Jd9sb2snO8ZFkdVxHSnKrqBKpgxcIb5pf43kwJcuYN4ZI+RnzAI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.52.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FwuSqTxZ86tn3L52N+ZPZjkyhqpDw3QQD78my6akrCS8GLH7Z8kuLVgjs4WRrJbC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.864.0/index.min.mjs": "sha384-FwuSqTxZ86tn3L52N+ZPZjkyhqpDw3QQD78my6akrCS8GLH7Z8kuLVgjs4WRrJbC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.864.0/LICENSE
```

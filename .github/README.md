...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0ASjahelHGLvNog76K1rbrgE9qkdiaOuIrR03qyow4Fsz4TMUnMgdMj9DLBgOT5h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.310.0/index.min.mjs": "sha384-0ASjahelHGLvNog76K1rbrgE9qkdiaOuIrR03qyow4Fsz4TMUnMgdMj9DLBgOT5h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.310.0/LICENSE
```

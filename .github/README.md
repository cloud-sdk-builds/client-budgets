...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.854.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.854.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BhhuRxHiWxfU0ry6fRnI7UigyIpMxSoXhQ8SDL9LJIJbhxpPkv5od16G8L7Zb/Zv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.854.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.854.0/index.min.mjs": "sha384-BhhuRxHiWxfU0ry6fRnI7UigyIpMxSoXhQ8SDL9LJIJbhxpPkv5od16G8L7Zb/Zv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.854.0/LICENSE
```

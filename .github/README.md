...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aaLntp6+iUJbglOtY0MsQFwpMUFcjMBMSewz/nw+w6CO9K4A9k6xT7QdMzgDyWi4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.271.0/index.min.mjs": "sha384-aaLntp6+iUJbglOtY0MsQFwpMUFcjMBMSewz/nw+w6CO9K4A9k6xT7QdMzgDyWi4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.271.0/LICENSE
```

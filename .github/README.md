...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-92jwbYMhIfpwRuOz4xid16rrr6zOxL6nio5hvXBhbVKbSulyPNRz7JlBoNh1ZmxS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.429.0/index.min.mjs": "sha384-92jwbYMhIfpwRuOz4xid16rrr6zOxL6nio5hvXBhbVKbSulyPNRz7JlBoNh1ZmxS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.429.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xOiN98wfY+4CoFUggTX2B1WXgg7Z6RXKwS8Ncqndr62RYfB+FN3U0ATS2UwmnnaD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.360.0/index.min.mjs": "sha384-xOiN98wfY+4CoFUggTX2B1WXgg7Z6RXKwS8Ncqndr62RYfB+FN3U0ATS2UwmnnaD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.360.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aEIBWumkVGpST63VhYVfdqiymN65H4XkaL2bXEuur5460l9PjzhX0NouK7OkJ30Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.899.0/index.min.mjs": "sha384-aEIBWumkVGpST63VhYVfdqiymN65H4XkaL2bXEuur5460l9PjzhX0NouK7OkJ30Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.899.0/LICENSE
```

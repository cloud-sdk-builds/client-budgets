...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-O9Ci3f+FAcA7NjFEErLrUUEhNC1O9uk5U2pmvT9rJ9RRqb4DX0QR5OZDj2J0PnmG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.266.1/index.min.mjs": "sha384-O9Ci3f+FAcA7NjFEErLrUUEhNC1O9uk5U2pmvT9rJ9RRqb4DX0QR5OZDj2J0PnmG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.266.1/LICENSE
```

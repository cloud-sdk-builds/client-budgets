...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8Xfu1lbEPm2X0SX4Fn7E/AS4wxuskUiyUFk0ts17h6fvaBvF1VNYB4I8IcvNbX/n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.830.0/index.min.mjs": "sha384-8Xfu1lbEPm2X0SX4Fn7E/AS4wxuskUiyUFk0ts17h6fvaBvF1VNYB4I8IcvNbX/n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.830.0/LICENSE
```

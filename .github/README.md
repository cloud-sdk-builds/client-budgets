...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DosD7puQ7de+QchID9dadoJtOrEsjznnwD+RFetEm9tABTMy4LLWh1tqlL0PgrWO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.312.0/index.min.mjs": "sha384-DosD7puQ7de+QchID9dadoJtOrEsjznnwD+RFetEm9tABTMy4LLWh1tqlL0PgrWO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.312.0/LICENSE
```

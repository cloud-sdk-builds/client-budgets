...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.99.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.99.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KYuKjsnHEF8HGQLVeK38oKVLBrdASshL8Yb9/zhJJdbyWG4YmTHOoVrc5IRifk30
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.99.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.99.0/index.min.mjs": "sha384-KYuKjsnHEF8HGQLVeK38oKVLBrdASshL8Yb9/zhJJdbyWG4YmTHOoVrc5IRifk30"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.99.0/LICENSE
```

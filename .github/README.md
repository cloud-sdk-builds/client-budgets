...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A+6/lKSLQoDluGAVrrFvRHBwRAYnenPLZ7xxbPM62qo8PxqE+CApL7Mz0xm9OkV6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.990.0/index.min.mjs": "sha384-A+6/lKSLQoDluGAVrrFvRHBwRAYnenPLZ7xxbPM62qo8PxqE+CApL7Mz0xm9OkV6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.990.0/LICENSE
```

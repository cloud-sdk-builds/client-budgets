...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OyCHv8GkQd9RmGacBaZVPi5iswxUHxWirxPS/iZVsLu8CosyV2df0e8oboDXlMjB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.252.0/index.min.mjs": "sha384-OyCHv8GkQd9RmGacBaZVPi5iswxUHxWirxPS/iZVsLu8CosyV2df0e8oboDXlMjB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.252.0/LICENSE
```

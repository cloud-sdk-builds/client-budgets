...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WWggjKfr9PhGoMo3x9SRrehihxKbuZri3UpooN3187topt01YMRKVv9KxMTrG9Yz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.20.0/index.min.mjs": "sha384-WWggjKfr9PhGoMo3x9SRrehihxKbuZri3UpooN3187topt01YMRKVv9KxMTrG9Yz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.20.0/LICENSE
```

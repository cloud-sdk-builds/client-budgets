...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+GXxpWUk7R3Sms3oNP27RLHJqTVwpnzmV/6Wv4+EPiWhb1sbLS5Z1u+kOMtztIZt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.478.0/index.min.mjs": "sha384-+GXxpWUk7R3Sms3oNP27RLHJqTVwpnzmV/6Wv4+EPiWhb1sbLS5Z1u+kOMtztIZt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.478.0/LICENSE
```

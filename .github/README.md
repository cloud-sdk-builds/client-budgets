...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N/l1DcxM9AcbcgS98IaS7P0Bk8mGbeKhnZG2SjM062qhDzHj7kHVNa0K8GHcHIZ/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.56.0/index.min.mjs": "sha384-N/l1DcxM9AcbcgS98IaS7P0Bk8mGbeKhnZG2SjM062qhDzHj7kHVNa0K8GHcHIZ/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.56.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0dkZR5Vm6rBAsCnpylcE+6dz2CNpFDsvm3li1io/HJjXrdj8c1PT1TAzkKiuvtuE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.58.0/index.min.mjs": "sha384-0dkZR5Vm6rBAsCnpylcE+6dz2CNpFDsvm3li1io/HJjXrdj8c1PT1TAzkKiuvtuE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.58.0/LICENSE
```

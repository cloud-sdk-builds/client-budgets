...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-28TEeW8rouS/zD8a8VEtuEMUuk9bnshJcvoZe4suFRn0O/vHvn0xXTW/c6XN4Gb9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.378.0/index.min.mjs": "sha384-28TEeW8rouS/zD8a8VEtuEMUuk9bnshJcvoZe4suFRn0O/vHvn0xXTW/c6XN4Gb9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.378.0/LICENSE
```

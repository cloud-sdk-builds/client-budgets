...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GyMO8m6UQaZ1wKY24FK8hXjiv7wZgHWGHxoizcAaH8gSKyDPeEPeR1r1mvAnjQo7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.301.0/index.min.mjs": "sha384-GyMO8m6UQaZ1wKY24FK8hXjiv7wZgHWGHxoizcAaH8gSKyDPeEPeR1r1mvAnjQo7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.301.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-re+vYfV6HsyAKvjk7u9H2ZJCwELeVxhQUixsXX+vvd7Vly5ztYI6XJkYY/J+2Psl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.16.0/index.min.mjs": "sha384-re+vYfV6HsyAKvjk7u9H2ZJCwELeVxhQUixsXX+vvd7Vly5ztYI6XJkYY/J+2Psl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.16.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S9d4nkFTiCQPzjjxfIkYO3L0LYGGyklNAyCvUuDndV+3X56Bod2IyIoo61fEDudv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.743.0/index.min.mjs": "sha384-S9d4nkFTiCQPzjjxfIkYO3L0LYGGyklNAyCvUuDndV+3X56Bod2IyIoo61fEDudv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.743.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-viPsnU9QWFLn/RV311v+uImR/8UkNT7ed1Y3M64SBvBezQQnfdP8/o2ml2HfbJq/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.908.0/index.min.mjs": "sha384-viPsnU9QWFLn/RV311v+uImR/8UkNT7ed1Y3M64SBvBezQQnfdP8/o2ml2HfbJq/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.908.0/LICENSE
```

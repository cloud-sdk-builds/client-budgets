...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R1pYClTlc+BF48aWvpwo5oY6KCO9yhq6geDgLRXmQGGq4xdL0h3HPWMEHO5JHLMk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.39.0/index.min.mjs": "sha384-R1pYClTlc+BF48aWvpwo5oY6KCO9yhq6geDgLRXmQGGq4xdL0h3HPWMEHO5JHLMk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.39.0/LICENSE
```

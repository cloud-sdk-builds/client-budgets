...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qmp31ZLkweCUytGybHYLvRrKn+czjRjJWbpG/UalVMi61cttz2071/d28vcq/M7h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.194.0/index.min.mjs": "sha384-qmp31ZLkweCUytGybHYLvRrKn+czjRjJWbpG/UalVMi61cttz2071/d28vcq/M7h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.194.0/LICENSE
```

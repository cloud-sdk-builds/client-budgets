...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xnwLjqmg3sNuY1UUJ+uvh278O0AiaD3ePj3LCagFbYq98OSgsf3YjhoARybHE3fS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.272.0/index.min.mjs": "sha384-xnwLjqmg3sNuY1UUJ+uvh278O0AiaD3ePj3LCagFbYq98OSgsf3YjhoARybHE3fS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.272.0/LICENSE
```

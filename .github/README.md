...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KIEXJ6kQqKP8ljZgmMoKmW+Yyx+4JLS4XFMxorYV7BNJALroEzi3T7fweuYJpXh3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.289.0/index.min.mjs": "sha384-KIEXJ6kQqKP8ljZgmMoKmW+Yyx+4JLS4XFMxorYV7BNJALroEzi3T7fweuYJpXh3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.289.0/LICENSE
```

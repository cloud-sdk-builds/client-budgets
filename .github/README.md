...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lCVEA8YR5+ir99teEQ+bjfla9hAsyr1ewdqhELtLSyHKqp20O7EK0p1qAQplX4Re
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.906.0/index.min.mjs": "sha384-lCVEA8YR5+ir99teEQ+bjfla9hAsyr1ewdqhELtLSyHKqp20O7EK0p1qAQplX4Re"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.906.0/LICENSE
```

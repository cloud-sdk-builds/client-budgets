...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L6eWveOjpcfBxeekQ5QPLuG9NDF5VBDlkkde6d62eK38IbNBfUqSuMLooD5Ij1Pg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.993.0/index.min.mjs": "sha384-L6eWveOjpcfBxeekQ5QPLuG9NDF5VBDlkkde6d62eK38IbNBfUqSuMLooD5Ij1Pg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.993.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nvmKyRB10IyEKmzGp3GGYuB5wabpWBwljtES3G1M0aT9W1BhVVOG0IG0SLUW+el7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.92.0/index.min.mjs": "sha384-nvmKyRB10IyEKmzGp3GGYuB5wabpWBwljtES3G1M0aT9W1BhVVOG0IG0SLUW+el7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.92.0/LICENSE
```

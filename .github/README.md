...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NiVvoqZeoNJ74PimBvy8cJ0nMzsoh5m5TeZMhz25pcCrFVVgogK8Xgqw3bx/sdAA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.823.0/index.min.mjs": "sha384-NiVvoqZeoNJ74PimBvy8cJ0nMzsoh5m5TeZMhz25pcCrFVVgogK8Xgqw3bx/sdAA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.823.0/LICENSE
```

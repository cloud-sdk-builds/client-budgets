...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.614.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.614.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-90Kuc/T5xm8zdZfRrEWkND+Cy6dZEFCTZrcUZfCUEhqT4pa2qiA1qLRgtLkflcBx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.614.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.614.0/index.min.mjs": "sha384-90Kuc/T5xm8zdZfRrEWkND+Cy6dZEFCTZrcUZfCUEhqT4pa2qiA1qLRgtLkflcBx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.614.0/LICENSE
```

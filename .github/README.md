...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yY7ZydN2BKU8H725vOltTtH3dY+CU+pB0VaXlBAkh9Qn88zaT3Uaddh13y+AgXpY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.414.0/index.min.mjs": "sha384-yY7ZydN2BKU8H725vOltTtH3dY+CU+pB0VaXlBAkh9Qn88zaT3Uaddh13y+AgXpY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.414.0/LICENSE
```

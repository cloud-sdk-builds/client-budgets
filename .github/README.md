...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sZz/S1sMR6ooBhI9bnbAB45YUQqto6ST9xSsu9b2bYeP0oy3ch5jBV5suzBO1qkd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.692.0/index.min.mjs": "sha384-sZz/S1sMR6ooBhI9bnbAB45YUQqto6ST9xSsu9b2bYeP0oy3ch5jBV5suzBO1qkd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.692.0/LICENSE
```

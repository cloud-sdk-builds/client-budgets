...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eGfsrRNJ9qFeTH4WOkyA2QdFoW82kxihgzJhCGH7UafbjhUjcuMEalmNun0Ivf4u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.798.0/index.min.mjs": "sha384-eGfsrRNJ9qFeTH4WOkyA2QdFoW82kxihgzJhCGH7UafbjhUjcuMEalmNun0Ivf4u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.798.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JLdk2pUl5Q3166N4DtDb2t1kl+Gz1i8An1UU75EBvwJ6rHJNrV7Z/wm7G3p+Phgx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.637.0/index.min.mjs": "sha384-JLdk2pUl5Q3166N4DtDb2t1kl+Gz1i8An1UU75EBvwJ6rHJNrV7Z/wm7G3p+Phgx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.637.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8at35gy7UyETF6iheO9anzXidMlLHFBzVT8daqA36rGEQTGWSnrS88MjIsdGlD4r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.803.0/index.min.mjs": "sha384-8at35gy7UyETF6iheO9anzXidMlLHFBzVT8daqA36rGEQTGWSnrS88MjIsdGlD4r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.803.0/LICENSE
```

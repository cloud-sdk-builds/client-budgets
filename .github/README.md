...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jyuj0/RmYlBSinaiZKVMK4Nx4blnMnUD8wRm/cg95U4ZfZZOdgV2E1gUmkUdhDoa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.0/index.min.mjs": "sha384-jyuj0/RmYlBSinaiZKVMK4Nx4blnMnUD8wRm/cg95U4ZfZZOdgV2E1gUmkUdhDoa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.47.0/LICENSE
```

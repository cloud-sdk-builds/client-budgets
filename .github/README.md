...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zD0+WekXK7jELYHkk8E1Q2gs8pJbRuD98LstxqBm5USWpY6CllTGqurGXR9soHIH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.441.0/index.min.mjs": "sha384-zD0+WekXK7jELYHkk8E1Q2gs8pJbRuD98LstxqBm5USWpY6CllTGqurGXR9soHIH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.441.0/LICENSE
```

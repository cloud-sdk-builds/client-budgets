...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VZdb5/CDIq2TWfgiA7XlRwgX78N0wks9uGeYH92abgQ/m8yrYdXmf1NFLlJNb0EF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.989.0/index.min.mjs": "sha384-VZdb5/CDIq2TWfgiA7XlRwgX78N0wks9uGeYH92abgQ/m8yrYdXmf1NFLlJNb0EF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.989.0/LICENSE
```

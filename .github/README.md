...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jbJZ/YI3BAURoxExE7CMVuuV2Gc10lRfjeFQ2AdDzLUYJRFS4xrkAS2stiXJncju
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.623.0/index.min.mjs": "sha384-jbJZ/YI3BAURoxExE7CMVuuV2Gc10lRfjeFQ2AdDzLUYJRFS4xrkAS2stiXJncju"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.623.0/LICENSE
```

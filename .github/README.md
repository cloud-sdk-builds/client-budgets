...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0l/eI6SDImTtPUFWP33vVrHv6uyFnLEBoLBObHe1d3vDrkx5iV6baDlrNFDEJhyl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.632.0/index.min.mjs": "sha384-0l/eI6SDImTtPUFWP33vVrHv6uyFnLEBoLBObHe1d3vDrkx5iV6baDlrNFDEJhyl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.632.0/LICENSE
```

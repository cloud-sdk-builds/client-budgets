...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9Z8S62pGwcXyEvdwVzufN7uL0FRqZgFubDcUVcwnmQDmITzeuKmtFYQYxm+np/JZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.496.0/index.min.mjs": "sha384-9Z8S62pGwcXyEvdwVzufN7uL0FRqZgFubDcUVcwnmQDmITzeuKmtFYQYxm+np/JZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.496.0/LICENSE
```

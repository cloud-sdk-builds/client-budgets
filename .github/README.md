...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+wzIq+Fy8tWAZKYv5x1cik6mzgR7D4pTZgpjXfMb/n5f/vWer+9vBou9VsI5bKZQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.787.0/index.min.mjs": "sha384-+wzIq+Fy8tWAZKYv5x1cik6mzgR7D4pTZgpjXfMb/n5f/vWer+9vBou9VsI5bKZQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.787.0/LICENSE
```

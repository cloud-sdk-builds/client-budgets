...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1030.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1030.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b57XNtTJmzbTPFT+rRxJgojTEsJjPjJKF/LxBtR39aeDW9WoLffRKWg5K5UH8ozw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1030.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1030.0/index.min.mjs": "sha384-b57XNtTJmzbTPFT+rRxJgojTEsJjPjJKF/LxBtR39aeDW9WoLffRKWg5K5UH8ozw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1030.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5AGPBTILIO01B+wk0yp4eMCjfWccFCRtsJnF2qpeYLHwcTOPbNsNv4YAnA0xm/NM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.46.0/index.min.mjs": "sha384-5AGPBTILIO01B+wk0yp4eMCjfWccFCRtsJnF2qpeYLHwcTOPbNsNv4YAnA0xm/NM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.46.0/LICENSE
```

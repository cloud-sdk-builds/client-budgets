...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lX6Z3zb8qMiktGhbYV0KH0wi6oazPKNl3HZeIIETDVkSIfia8WNUFux3nSh63Iwg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.241.0/index.min.mjs": "sha384-lX6Z3zb8qMiktGhbYV0KH0wi6oazPKNl3HZeIIETDVkSIfia8WNUFux3nSh63Iwg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.241.0/LICENSE
```

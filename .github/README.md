...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hpt8W6joyN2K4bDg/0Oscc0VEcwtVstvs8kaD6uv81Kn8fgPk3bNMrbDOIOuTjRl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.844.0/index.min.mjs": "sha384-hpt8W6joyN2K4bDg/0Oscc0VEcwtVstvs8kaD6uv81Kn8fgPk3bNMrbDOIOuTjRl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.844.0/LICENSE
```

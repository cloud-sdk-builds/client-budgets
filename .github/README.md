...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1013.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1013.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6QEAF0gJ+QB1eIUTr8Mojayc/nqNVueF/9yFN7HwGTQisqjsoYAFS4eLWFMqTtvc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1013.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1013.0/index.min.mjs": "sha384-6QEAF0gJ+QB1eIUTr8Mojayc/nqNVueF/9yFN7HwGTQisqjsoYAFS4eLWFMqTtvc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1013.0/LICENSE
```

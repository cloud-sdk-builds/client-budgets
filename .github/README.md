...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7HMsuX35YqNC0ICQ1iQb+YcOQuZ5NKXhSIqQSNaZrIDc7JGbfI+gpFG/xraicPzn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.430.0/index.min.mjs": "sha384-7HMsuX35YqNC0ICQ1iQb+YcOQuZ5NKXhSIqQSNaZrIDc7JGbfI+gpFG/xraicPzn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.430.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LRB9NoMesy8WjLlITEBUtdeaAomXek0nIA0q+ZddKuJgoSA8iYYl5o2UtuzH97ln
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.294.0/index.min.mjs": "sha384-LRB9NoMesy8WjLlITEBUtdeaAomXek0nIA0q+ZddKuJgoSA8iYYl5o2UtuzH97ln"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.294.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xmjHm1O+pRZwpr8aGJHOGGzEb6Knz8zf4PvYxFPw81s7tJ72tHeHwqoNun3ssiH3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.799.0/index.min.mjs": "sha384-xmjHm1O+pRZwpr8aGJHOGGzEb6Knz8zf4PvYxFPw81s7tJ72tHeHwqoNun3ssiH3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.799.0/LICENSE
```

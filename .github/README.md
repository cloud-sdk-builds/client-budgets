...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CI5TnGmjY9s1hiUOm8y6j33ZtN5jLL+dP2I/PZpyjxWGcC7v/SCLcw0HksOIVrx8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.928.0/index.min.mjs": "sha384-CI5TnGmjY9s1hiUOm8y6j33ZtN5jLL+dP2I/PZpyjxWGcC7v/SCLcw0HksOIVrx8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.928.0/LICENSE
```

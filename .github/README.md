...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1007.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1007.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zev5r2Hx0EOp+AbGD3NCte2D2zFImaILAmKstlM/VKxHljMcGagr7DPuFbMx++MZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1007.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1007.0/index.min.mjs": "sha384-Zev5r2Hx0EOp+AbGD3NCte2D2zFImaILAmKstlM/VKxHljMcGagr7DPuFbMx++MZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1007.0/LICENSE
```

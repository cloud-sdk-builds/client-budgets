...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f4cregVvmK+jHXg4enHl1k7/F53J6SeQkN3d7UQSbQPUmZZ7B1qKEPV2Oz8HSZnJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.821.0/index.min.mjs": "sha384-f4cregVvmK+jHXg4enHl1k7/F53J6SeQkN3d7UQSbQPUmZZ7B1qKEPV2Oz8HSZnJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.821.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p7Dxmt8yFi5X/wLpwe6XXKUy4kMmOQX44yqd98nVvEB4F8HYvT5hGGhDsdCoMXPD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.955.0/index.min.mjs": "sha384-p7Dxmt8yFi5X/wLpwe6XXKUy4kMmOQX44yqd98nVvEB4F8HYvT5hGGhDsdCoMXPD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.955.0/LICENSE
```

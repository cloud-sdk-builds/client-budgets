...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.3.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.3.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O/vcrsp+kI+FDJPF4lA98S+xpLD6QT6Xs/bWz4VdNxadXICQHKYKAJGsmnU/gXI1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.3.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.3.0/index.min.mjs": "sha384-O/vcrsp+kI+FDJPF4lA98S+xpLD6QT6Xs/bWz4VdNxadXICQHKYKAJGsmnU/gXI1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.3.0/LICENSE
```

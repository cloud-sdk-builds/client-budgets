...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qufJ2kAaAbUST1FqREmevIc7PQyMPeTG0Zb2WJOfHomrqP6zQjUU4rWQAojUylb1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.43.0/index.min.mjs": "sha384-qufJ2kAaAbUST1FqREmevIc7PQyMPeTG0Zb2WJOfHomrqP6zQjUU4rWQAojUylb1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.43.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oQwhDfQ6GSWpDn1kTT8qrTUNLD1twGVrttA26094YvkSen3dUZD8H+Iwx3Ve2xxE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.369.0/index.min.mjs": "sha384-oQwhDfQ6GSWpDn1kTT8qrTUNLD1twGVrttA26094YvkSen3dUZD8H+Iwx3Ve2xxE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.369.0/LICENSE
```

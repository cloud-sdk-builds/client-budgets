...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YZERNqnjMJNfXm8mOqb0qAM9+ZQ6Wej5KxbJ/NqqzBWZGJTFop7jF69pOn3URlLj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.592.0/index.min.mjs": "sha384-YZERNqnjMJNfXm8mOqb0qAM9+ZQ6Wej5KxbJ/NqqzBWZGJTFop7jF69pOn3URlLj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.592.0/LICENSE
```

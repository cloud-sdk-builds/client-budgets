...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9ZwCSFKkSqRdina3pMx0A8Ijtc8bVL/IqUlrwk9uu/8USWayHhwIX1K6zgLY9Kuk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.54.0/index.min.mjs": "sha384-9ZwCSFKkSqRdina3pMx0A8Ijtc8bVL/IqUlrwk9uu/8USWayHhwIX1K6zgLY9Kuk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.54.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OYGCCRx1JT71WrT02tlAA7jxwD9NqLUWP9INpK2cOnKgtpgKsFW6/cz+j2HkmuiP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.370.0/index.min.mjs": "sha384-OYGCCRx1JT71WrT02tlAA7jxwD9NqLUWP9INpK2cOnKgtpgKsFW6/cz+j2HkmuiP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.370.0/LICENSE
```

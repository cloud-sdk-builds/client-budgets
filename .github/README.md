...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gpbK6vtO2Z5bgWCa9b9O9rb8S2NHHBqQP6a8RWAlX1vnAk9QJX38J+btbV+2d8ju
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.11.0/index.min.mjs": "sha384-gpbK6vtO2Z5bgWCa9b9O9rb8S2NHHBqQP6a8RWAlX1vnAk9QJX38J+btbV+2d8ju"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.11.0/LICENSE
```

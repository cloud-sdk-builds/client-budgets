...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YbvDFhqKRZhuhc2TyxerzQk8vjIEi6GoQ/KEj2OAtw3RbZO7SB0LwIHcDWSbASCH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.940.0/index.min.mjs": "sha384-YbvDFhqKRZhuhc2TyxerzQk8vjIEi6GoQ/KEj2OAtw3RbZO7SB0LwIHcDWSbASCH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.940.0/LICENSE
```

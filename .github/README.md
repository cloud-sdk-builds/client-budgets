...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yhuoSTmZtAr7C5pUCvZi/8gbfHeDZpHStSBF05gmIkmFJj/tjTey04fEC/3pSDYL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.495.0/index.min.mjs": "sha384-yhuoSTmZtAr7C5pUCvZi/8gbfHeDZpHStSBF05gmIkmFJj/tjTey04fEC/3pSDYL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.495.0/LICENSE
```

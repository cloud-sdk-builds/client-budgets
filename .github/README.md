...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-74orXsX1rw6ehL/hEEatyn2hudNNl/kgMuQi8Emm62DkgxUl3Kr8otnIQJoebmyW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.82.0/index.min.mjs": "sha384-74orXsX1rw6ehL/hEEatyn2hudNNl/kgMuQi8Emm62DkgxUl3Kr8otnIQJoebmyW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.82.0/LICENSE
```

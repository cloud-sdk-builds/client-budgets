...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g6hT6PM1ckDSdN5R9p0B7EMtMUmy4xaCyLzfz7qg6T3KWW2sUm6/fAdUo9hHm272
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.37.0/index.min.mjs": "sha384-g6hT6PM1ckDSdN5R9p0B7EMtMUmy4xaCyLzfz7qg6T3KWW2sUm6/fAdUo9hHm272"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.37.0/LICENSE
```

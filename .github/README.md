...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rT1b2QoZgDrPen8khsS3ZBQX9Xd1Zy9AtyDoP8QPEK57xswurcaHpFM7Dl6bJGK+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.460.0/index.min.mjs": "sha384-rT1b2QoZgDrPen8khsS3ZBQX9Xd1Zy9AtyDoP8QPEK57xswurcaHpFM7Dl6bJGK+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.460.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+CSMkoa7LTBgu+l4ExPsm6OowqPuJYX+meFV7oUvShS/el7QVZAzskcgVMDQME6K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.300.0/index.min.mjs": "sha384-+CSMkoa7LTBgu+l4ExPsm6OowqPuJYX+meFV7oUvShS/el7QVZAzskcgVMDQME6K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.300.0/LICENSE
```

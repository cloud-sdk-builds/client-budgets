...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xC+KZnusDAQyCOgCOCZ/hlQDq7Eo9z56qdmOhXxpsVG279C8X6xIMcjbBT77W5IM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.999.0/index.min.mjs": "sha384-xC+KZnusDAQyCOgCOCZ/hlQDq7Eo9z56qdmOhXxpsVG279C8X6xIMcjbBT77W5IM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.999.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fAFDsePpc5g3CvdQNlUc9Ch8A3IxRStq++LeKz+H4t6nyM1pU4th/oWeQpS+R63Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.180.0/index.min.mjs": "sha384-fAFDsePpc5g3CvdQNlUc9Ch8A3IxRStq++LeKz+H4t6nyM1pU4th/oWeQpS+R63Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.180.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1035.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1035.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P443tAdwEVkWYTPvLB1TAK4E/aQcefNBg+VZiDwqKoZu3WbRgmdPDqFl9TberXVE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1035.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1035.0/index.min.mjs": "sha384-P443tAdwEVkWYTPvLB1TAK4E/aQcefNBg+VZiDwqKoZu3WbRgmdPDqFl9TberXVE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1035.0/LICENSE
```

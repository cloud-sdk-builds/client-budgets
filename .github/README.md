...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c/tKQ4vdcFHBnFYGB40PtGnWDqkkM0Xjd6YVsyiLGp6Jxexy+cozLNNuk4t7GAaT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.18.0/index.min.mjs": "sha384-c/tKQ4vdcFHBnFYGB40PtGnWDqkkM0Xjd6YVsyiLGp6Jxexy+cozLNNuk4t7GAaT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.18.0/LICENSE
```

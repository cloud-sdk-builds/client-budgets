...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xvX6xCxkZTzHDY6d77rEwM7xmLSZCkSEC1Z4FfuFecuTfv/ETInBPyAMMeGlRm0c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.328.0/index.min.mjs": "sha384-xvX6xCxkZTzHDY6d77rEwM7xmLSZCkSEC1Z4FfuFecuTfv/ETInBPyAMMeGlRm0c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.328.0/LICENSE
```

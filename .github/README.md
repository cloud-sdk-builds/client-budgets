...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BkWWWb3oBKhgXaW19jy6WILByjsYXzOYV2MMzFNZsAiWSse0FeZJNIZlAV+cRsqp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.160.0/index.min.mjs": "sha384-BkWWWb3oBKhgXaW19jy6WILByjsYXzOYV2MMzFNZsAiWSse0FeZJNIZlAV+cRsqp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.160.0/LICENSE
```

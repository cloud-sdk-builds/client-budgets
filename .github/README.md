...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IFnRf/wq1YO3ZW9I19DcBDq3OuQrgNwo+xoilJrHYhwKF+S2uYdyTZQqB/zwXRvg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.213.0/index.min.mjs": "sha384-IFnRf/wq1YO3ZW9I19DcBDq3OuQrgNwo+xoilJrHYhwKF+S2uYdyTZQqB/zwXRvg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.213.0/LICENSE
```

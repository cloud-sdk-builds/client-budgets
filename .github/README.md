...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+90G7NAz4ZkxJmttkMwtfDNiEhxP3ptg4GUAvAUhsFnvFpywp7k8a1Faru+WrUNl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.502.0/index.min.mjs": "sha384-+90G7NAz4ZkxJmttkMwtfDNiEhxP3ptg4GUAvAUhsFnvFpywp7k8a1Faru+WrUNl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.502.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6bmwqhDxAS7y602qT5wgtnIC5hAgQARJ24B1/P8BExf7hd3qKO0qShaUW6/zTIqR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.535.0/index.min.mjs": "sha384-6bmwqhDxAS7y602qT5wgtnIC5hAgQARJ24B1/P8BExf7hd3qKO0qShaUW6/zTIqR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.535.0/LICENSE
```

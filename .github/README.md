...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-djcxk4gwo43uKWj6HCSO0t4Pti0J0y8C/JgHUV7A1Q10uYQktIP0peS1Np7duspR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.223.0/index.min.mjs": "sha384-djcxk4gwo43uKWj6HCSO0t4Pti0J0y8C/JgHUV7A1Q10uYQktIP0peS1Np7duspR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.223.0/LICENSE
```

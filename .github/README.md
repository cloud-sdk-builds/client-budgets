...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7yU3NakusFlgqevQG5n4FitjNam4nS10Hfj02+MNhpmSQTRb067YKFsEU6AvFKPy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.40.0/index.min.mjs": "sha384-7yU3NakusFlgqevQG5n4FitjNam4nS10Hfj02+MNhpmSQTRb067YKFsEU6AvFKPy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.40.0/LICENSE
```

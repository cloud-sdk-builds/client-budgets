...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mg3gWc1Z3heufs4odzSlIUiEMn+dcCgT/9RzuhS80vXrSNOT8AEZjnmyxTRWXJh8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.952.0/index.min.mjs": "sha384-Mg3gWc1Z3heufs4odzSlIUiEMn+dcCgT/9RzuhS80vXrSNOT8AEZjnmyxTRWXJh8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.952.0/LICENSE
```

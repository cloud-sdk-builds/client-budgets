...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.12.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.12.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IJdR+vV5pOrCEoEYlUUW0AYw0VN6ih4kddtVTBitk7v8hncAYczYp2gu6TberSR4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.12.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.12.0/index.min.mjs": "sha384-IJdR+vV5pOrCEoEYlUUW0AYw0VN6ih4kddtVTBitk7v8hncAYczYp2gu6TberSR4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.12.0/LICENSE
```

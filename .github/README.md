...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sc2MzvSNt3LiMGPsOvxTLZZKo3UHnfRnS/t1FS9ETZeoVgkVdx6e2jcR5CH54qoN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.873.0/index.min.mjs": "sha384-sc2MzvSNt3LiMGPsOvxTLZZKo3UHnfRnS/t1FS9ETZeoVgkVdx6e2jcR5CH54qoN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.873.0/LICENSE
```

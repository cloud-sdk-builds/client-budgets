...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xVR6CYpDubKdPehtAU47Wjiy8tTByrf9ZN7u1IPDs4oHx0Wfm/D7rHcoWTOAEamL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.696.0/index.min.mjs": "sha384-xVR6CYpDubKdPehtAU47Wjiy8tTByrf9ZN7u1IPDs4oHx0Wfm/D7rHcoWTOAEamL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.696.0/LICENSE
```

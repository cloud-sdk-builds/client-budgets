...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mTit8KexfWQpDuXBw6WN5IyYEWPdmPwgjo1KEkdECVixpQ0xu5ObKSxTxEUEZf86
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.856.0/index.min.mjs": "sha384-mTit8KexfWQpDuXBw6WN5IyYEWPdmPwgjo1KEkdECVixpQ0xu5ObKSxTxEUEZf86"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.856.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-lSxWSuwfu/EZS3pKRY9Mf77rJL2X7L4mn3pjA1Q2MC3lqY8tgAsocJFYLuNVXDCt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.47.1/index.min.mjs": "sha384-lSxWSuwfu/EZS3pKRY9Mf77rJL2X7L4mn3pjA1Q2MC3lqY8tgAsocJFYLuNVXDCt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.47.1/LICENSE
```

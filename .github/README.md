...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nU5OV2vgXXEvPWImCrkVzrTm/DnAK8HzLvTN1fGzrSzAU6hLdpvHtTSNs+m8q6Jp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.994.0/index.min.mjs": "sha384-nU5OV2vgXXEvPWImCrkVzrTm/DnAK8HzLvTN1fGzrSzAU6hLdpvHtTSNs+m8q6Jp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.994.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SbiCryqBVLrE7XkEZ6avrPbT8ZECDpd0YDJbTcUgN8iRjAPgnZjXtyg5s1WgDonO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.649.0/index.min.mjs": "sha384-SbiCryqBVLrE7XkEZ6avrPbT8ZECDpd0YDJbTcUgN8iRjAPgnZjXtyg5s1WgDonO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-degHacelSXQ9558hfsv1KAOH+5NlOYtPQLw0OmApBDTdnW5lEEEMZwwX4OM/jmbw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.14.0/index.min.mjs": "sha384-degHacelSXQ9558hfsv1KAOH+5NlOYtPQLw0OmApBDTdnW5lEEEMZwwX4OM/jmbw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.14.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xb2sa+QBig3TJ0I5UJ3batTtb7ybJIXS7x4P3ciIHFlJnJniE2xwtgT7ki2gtuR/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.481.0/index.min.mjs": "sha384-xb2sa+QBig3TJ0I5UJ3batTtb7ybJIXS7x4P3ciIHFlJnJniE2xwtgT7ki2gtuR/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.481.0/LICENSE
```

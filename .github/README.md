...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1018.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1018.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yQfEd98eOuA2b8viERkWOCS7VqIPRQ+S/uqivg/1HqFpDXPLfHkC3X1qJm3+6c7Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1018.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1018.0/index.min.mjs": "sha384-yQfEd98eOuA2b8viERkWOCS7VqIPRQ+S/uqivg/1HqFpDXPLfHkC3X1qJm3+6c7Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1018.0/LICENSE
```

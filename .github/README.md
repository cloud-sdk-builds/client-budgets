...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XaNoPzPKbthl6yXqCOopKjBKGxLxN6iv1hsgc9VmOU44Go8/K/MiOMgUz8DvkyGz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.6.0/index.min.mjs": "sha384-XaNoPzPKbthl6yXqCOopKjBKGxLxN6iv1hsgc9VmOU44Go8/K/MiOMgUz8DvkyGz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.6.0/LICENSE
```

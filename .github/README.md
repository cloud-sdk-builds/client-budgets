...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XutoX4bHjaQLccty7Avzfc407Cjj0GStuZVpVKz9NIrwHbWgFJy0pITR0XgYjK9Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.658.0/index.min.mjs": "sha384-XutoX4bHjaQLccty7Avzfc407Cjj0GStuZVpVKz9NIrwHbWgFJy0pITR0XgYjK9Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.658.0/LICENSE
```

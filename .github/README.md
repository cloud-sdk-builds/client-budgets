...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sEkuV4Vp5psNYlcGS9yRAjwqtM5fncBkQbUe6ktG6aKpkxM0jS4o3t6HwgW0mGfi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.662.0/index.min.mjs": "sha384-sEkuV4Vp5psNYlcGS9yRAjwqtM5fncBkQbUe6ktG6aKpkxM0jS4o3t6HwgW0mGfi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.662.0/LICENSE
```

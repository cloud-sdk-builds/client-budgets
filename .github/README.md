...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+ccGGLcd0nCB6L9z6T4OH0pfAA/ANPcen6shaD+ztLn1KCRcTUJYdnTZu6/Dy1rJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.987.0/index.min.mjs": "sha384-+ccGGLcd0nCB6L9z6T4OH0pfAA/ANPcen6shaD+ztLn1KCRcTUJYdnTZu6/Dy1rJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.987.0/LICENSE
```

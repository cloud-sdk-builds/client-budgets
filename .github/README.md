...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I1e2BRZrF9K2UjDuCSSQmhLyBxdrx9INjF9t5NaglGv44i4nbQn0GVYFb4jmX7vA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.53.0/index.min.mjs": "sha384-I1e2BRZrF9K2UjDuCSSQmhLyBxdrx9INjF9t5NaglGv44i4nbQn0GVYFb4jmX7vA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.53.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YuV8K+XgTrpSm2NQPlpuQ8p0TI/ul5TnfWFu93/b+swUkv5iPRFDsE4t59m9E8gt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.664.0/index.min.mjs": "sha384-YuV8K+XgTrpSm2NQPlpuQ8p0TI/ul5TnfWFu93/b+swUkv5iPRFDsE4t59m9E8gt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.664.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i2A34AhLstCERtS5r4M6HQ102pa1uEPJYLJkIvVECRdRDGME2ioRjrIAHpJ87++c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.458.0/index.min.mjs": "sha384-i2A34AhLstCERtS5r4M6HQ102pa1uEPJYLJkIvVECRdRDGME2ioRjrIAHpJ87++c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.458.0/LICENSE
```

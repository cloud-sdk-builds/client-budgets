...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1wB0119iL//AzaCEYk4Yp9JrK6YOuYHKTPgSGFbylTm7a/h39wS+RCcgzqWB2CHW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.859.0/index.min.mjs": "sha384-1wB0119iL//AzaCEYk4Yp9JrK6YOuYHKTPgSGFbylTm7a/h39wS+RCcgzqWB2CHW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.859.0/LICENSE
```

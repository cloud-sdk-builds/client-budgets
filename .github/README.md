...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3fCMHsbKNfhTlI+eDpQof1V+8b+vjoG5zL0KaEJYLK8TSWW7clCAa7An+9WjmDw/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.130.0/index.min.mjs": "sha384-3fCMHsbKNfhTlI+eDpQof1V+8b+vjoG5zL0KaEJYLK8TSWW7clCAa7An+9WjmDw/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.130.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WEGQnejAbB640aoMJ5x4lxmO3O4jlnCsiKOV0k4RSNKnEqLdn/Oot3Ab7Jeol1ec
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.921.0/index.min.mjs": "sha384-WEGQnejAbB640aoMJ5x4lxmO3O4jlnCsiKOV0k4RSNKnEqLdn/Oot3Ab7Jeol1ec"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.921.0/LICENSE
```

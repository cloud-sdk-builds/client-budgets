...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1027.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1027.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JpUvhRYgOSWk7vvC3C+pAe4Ln/xyfM8RYiuYG8zCTgGOMSKvBT9oxYvqpOsdmV8Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1027.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1027.0/index.min.mjs": "sha384-JpUvhRYgOSWk7vvC3C+pAe4Ln/xyfM8RYiuYG8zCTgGOMSKvBT9oxYvqpOsdmV8Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1027.0/LICENSE
```

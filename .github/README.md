...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SCO/vophdQICKoS2+ne3B8nSk1Tyb4FbgCfjnYWh+Ygn+SbhiXAThjQT6o9FTu7f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.962.0/index.min.mjs": "sha384-SCO/vophdQICKoS2+ne3B8nSk1Tyb4FbgCfjnYWh+Ygn+SbhiXAThjQT6o9FTu7f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.962.0/LICENSE
```

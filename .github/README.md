...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x5R6VUnEyKzm6Pe/fTRDel7wI52Sz4oh2QqT2/rNmpq26+d3wJktJ4ntHinhVgOB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.377.0/index.min.mjs": "sha384-x5R6VUnEyKzm6Pe/fTRDel7wI52Sz4oh2QqT2/rNmpq26+d3wJktJ4ntHinhVgOB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.377.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-OTWrw0fKGBJOGslVWgJZE11pi8VDpUqDWR3Uugu54HLXayfhdzH0fHjR0rVbE7Gn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.13.1/index.min.mjs": "sha384-OTWrw0fKGBJOGslVWgJZE11pi8VDpUqDWR3Uugu54HLXayfhdzH0fHjR0rVbE7Gn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.13.1/LICENSE
```

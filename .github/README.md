...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rmZySiZe/5ZRajB6PCairnACZp5tWwK9YimYhHc/6yzXkqKo9ijj7HR9ZZtE1kwD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.185.0/index.min.mjs": "sha384-rmZySiZe/5ZRajB6PCairnACZp5tWwK9YimYhHc/6yzXkqKo9ijj7HR9ZZtE1kwD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.185.0/LICENSE
```

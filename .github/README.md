...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1014.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1014.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yuineJ9/2gggId5CsInGWzF3ldjyMUIdr4cFQM8w8M3SamfcfxuuCeCTamxqnpoe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1014.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1014.0/index.min.mjs": "sha384-yuineJ9/2gggId5CsInGWzF3ldjyMUIdr4cFQM8w8M3SamfcfxuuCeCTamxqnpoe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1014.0/LICENSE
```

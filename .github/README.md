...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TL0A19rA4guMHcQbY2pgz68Vd524qJrzwxrEwHjDli5rZqT8WAkt+AzINdSe0jrV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.226.0/index.min.mjs": "sha384-TL0A19rA4guMHcQbY2pgz68Vd524qJrzwxrEwHjDli5rZqT8WAkt+AzINdSe0jrV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.226.0/LICENSE
```

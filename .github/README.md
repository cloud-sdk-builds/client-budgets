...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1025.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1025.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2feZuVDfw+l15NQP9yiO+7I7YUWWOM2sSzTBXFtKIoKRl46dLd0RquMBpOhsaZvV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1025.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1025.0/index.min.mjs": "sha384-2feZuVDfw+l15NQP9yiO+7I7YUWWOM2sSzTBXFtKIoKRl46dLd0RquMBpOhsaZvV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1025.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QWgcxltKoFKa7N0UiyZZu+7aM+rRlw4EXQ3vZ/Yy1kKNvc6FKTRwkFafSFGyCtdE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.468.0/index.min.mjs": "sha384-QWgcxltKoFKa7N0UiyZZu+7aM+rRlw4EXQ3vZ/Yy1kKNvc6FKTRwkFafSFGyCtdE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.468.0/LICENSE
```

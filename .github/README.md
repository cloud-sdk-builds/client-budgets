...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YCcbaezoNefjbrd8x83ZocjNn5yFm1/xDf5gW9IA7Ps+Uh1R8zgU7rUCdLczdnxX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.930.0/index.min.mjs": "sha384-YCcbaezoNefjbrd8x83ZocjNn5yFm1/xDf5gW9IA7Ps+Uh1R8zgU7rUCdLczdnxX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.930.0/LICENSE
```

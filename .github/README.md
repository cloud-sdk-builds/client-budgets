...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WyFZkXMqojDXL9ATF49hyNycMKQRbMhaz06ur6nNJ4YVlkJfmws316TL8Pu4BI8v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.943.0/index.min.mjs": "sha384-WyFZkXMqojDXL9ATF49hyNycMKQRbMhaz06ur6nNJ4YVlkJfmws316TL8Pu4BI8v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.943.0/LICENSE
```

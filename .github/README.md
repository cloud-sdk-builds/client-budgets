...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-PaBmoP8WT+c9+8akChE+AVbwd9qaU/GASXr3yB9vQmqJa+swcBQBVD7P1p6SFswT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.726.1/index.min.mjs": "sha384-PaBmoP8WT+c9+8akChE+AVbwd9qaU/GASXr3yB9vQmqJa+swcBQBVD7P1p6SFswT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.726.1/LICENSE
```

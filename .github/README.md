...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xsm/jmfK/CpcNAkWm/Y/6jZ5uUZSieVfpsQB/zOwtCILKr3dfdJPyIIeIXflev9E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.142.0/index.min.mjs": "sha384-xsm/jmfK/CpcNAkWm/Y/6jZ5uUZSieVfpsQB/zOwtCILKr3dfdJPyIIeIXflev9E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.142.0/LICENSE
```

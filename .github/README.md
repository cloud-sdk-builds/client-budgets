...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nPUwXKIF9hYTek1fQg/+64UieEVBJ2lIbcCisBV7WPmxnL+QapCMDxZA//w6I8fM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.985.0/index.min.mjs": "sha384-nPUwXKIF9hYTek1fQg/+64UieEVBJ2lIbcCisBV7WPmxnL+QapCMDxZA//w6I8fM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.985.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4dfAnXODCr6IgC8xrYALnuSYGE5ZfW+ZMDX0YSjup9pCN4zEHYi4OuDhdGbB1k/A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.145.0/index.min.mjs": "sha384-4dfAnXODCr6IgC8xrYALnuSYGE5ZfW+ZMDX0YSjup9pCN4zEHYi4OuDhdGbB1k/A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.145.0/LICENSE
```

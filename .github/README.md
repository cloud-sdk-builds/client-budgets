...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bgAUHIuxQt3HBfSs9IXjrrq4nmb2xE2+Z5EU0htCXB1ivoAo/4JM5MttGsWTePdq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.699.0/index.min.mjs": "sha384-bgAUHIuxQt3HBfSs9IXjrrq4nmb2xE2+Z5EU0htCXB1ivoAo/4JM5MttGsWTePdq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.699.0/LICENSE
```

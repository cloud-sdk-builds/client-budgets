...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wUAg0oCTfSE9h/wrDUU3WXVYL25cTpQquuW7RFF+VUE1GRmPb1cofu9DJBNS6bgB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.254.0/index.min.mjs": "sha384-wUAg0oCTfSE9h/wrDUU3WXVYL25cTpQquuW7RFF+VUE1GRmPb1cofu9DJBNS6bgB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.254.0/LICENSE
```

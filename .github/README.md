...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dWnpOj/+0F5IuFLdlLaJMHvTvT68GBkoREV4QiCN/45LaC5KP77VGcysXoLw+VlU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.817.0/index.min.mjs": "sha384-dWnpOj/+0F5IuFLdlLaJMHvTvT68GBkoREV4QiCN/45LaC5KP77VGcysXoLw+VlU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.817.0/LICENSE
```

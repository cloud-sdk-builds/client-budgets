...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O55WySx+oC9S/ymFbFtOM6qdPw7JszLhK0BQZUR46w1JO04d9LQls+FZJHE+uZAq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.353.0/index.min.mjs": "sha384-O55WySx+oC9S/ymFbFtOM6qdPw7JszLhK0BQZUR46w1JO04d9LQls+FZJHE+uZAq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.353.0/LICENSE
```

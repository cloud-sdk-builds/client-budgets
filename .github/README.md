...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.793.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.793.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xUBUuvlUB7hHDwfxtwNEJnGD0nRiJMNVdKBrUxBUGDpIVC59A0E27nvBI9pByZiA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.793.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.793.0/index.min.mjs": "sha384-xUBUuvlUB7hHDwfxtwNEJnGD0nRiJMNVdKBrUxBUGDpIVC59A0E27nvBI9pByZiA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.793.0/LICENSE
```

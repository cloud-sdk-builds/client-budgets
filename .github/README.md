...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4L7LXJJTrUkE6O2ya/+LMFrEE6Y4i89Q5BAJ+2jOO1P06qdWFG/k9DF19isErhXn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.33.0/index.min.mjs": "sha384-4L7LXJJTrUkE6O2ya/+LMFrEE6Y4i89Q5BAJ+2jOO1P06qdWFG/k9DF19isErhXn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.33.0/LICENSE
```

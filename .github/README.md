...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.208.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.208.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0MJCYdz4225wJK7TVJe8eKOAqnZUMu/ixpQmreyU+wa58ZsjghTHQMbz3i74w4GK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.208.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.208.0/index.min.mjs": "sha384-0MJCYdz4225wJK7TVJe8eKOAqnZUMu/ixpQmreyU+wa58ZsjghTHQMbz3i74w4GK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.208.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KaQi8/0Ac3cozCb6ZiMQaS9iamcbPQYjx5ijuREsBdo70WgNRVHT5cLzWvLTKQi2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.87.0/index.min.mjs": "sha384-KaQi8/0Ac3cozCb6ZiMQaS9iamcbPQYjx5ijuREsBdo70WgNRVHT5cLzWvLTKQi2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.87.0/LICENSE
```

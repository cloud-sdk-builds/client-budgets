...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FkO8R3XmC3oliMAsfMZcc91Qk6OZvNBGf38HCnP3x5VxibDR1MY0BXuKmtSlQHMp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.855.0/index.min.mjs": "sha384-FkO8R3XmC3oliMAsfMZcc91Qk6OZvNBGf38HCnP3x5VxibDR1MY0BXuKmtSlQHMp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.855.0/LICENSE
```

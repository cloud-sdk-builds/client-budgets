...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-LrlUtayg65npr91HMxRWTqiikEmS6g7T+9jN7ewHUYbt1y3jssb6juuI1GJijn2H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.6.1/index.min.mjs": "sha384-LrlUtayg65npr91HMxRWTqiikEmS6g7T+9jN7ewHUYbt1y3jssb6juuI1GJijn2H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.6.1/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1033.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1033.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cY7YhxavjHQmh4EJnVnaY2YgvkiGl0oPxCnX0ZyWGxaWHpN3pr46AS1q8eeL5EcA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1033.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1033.0/index.min.mjs": "sha384-cY7YhxavjHQmh4EJnVnaY2YgvkiGl0oPxCnX0ZyWGxaWHpN3pr46AS1q8eeL5EcA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1033.0/LICENSE
```

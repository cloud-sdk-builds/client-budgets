...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PfvDRonOTWhCmDDgnut9cxzJqIoFr9slvlE9778zYH2S2cBwhc/wGXfA4wWBdQ1C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.154.0/index.min.mjs": "sha384-PfvDRonOTWhCmDDgnut9cxzJqIoFr9slvlE9778zYH2S2cBwhc/wGXfA4wWBdQ1C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.154.0/LICENSE
```

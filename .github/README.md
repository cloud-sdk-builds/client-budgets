...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XAwRVfvVtM4IHEn8v6V03mUAsXvmlO/YV+iOJGlxmAp/IgIlJHx+GLleReOnpiy3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.319.0/index.min.mjs": "sha384-XAwRVfvVtM4IHEn8v6V03mUAsXvmlO/YV+iOJGlxmAp/IgIlJHx+GLleReOnpiy3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.319.0/LICENSE
```

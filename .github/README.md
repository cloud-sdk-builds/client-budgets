...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5Vz3Z7UYOOI2jCP1oQeFTio/EvWouwiaQZaAxmaA3HdAfFVa/20Yatyd23VMfDMl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.38.0/index.min.mjs": "sha384-5Vz3Z7UYOOI2jCP1oQeFTio/EvWouwiaQZaAxmaA3HdAfFVa/20Yatyd23VMfDMl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.38.0/LICENSE
```

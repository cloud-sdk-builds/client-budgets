...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BufXycHUB4+6mnFDa/BUJTAdR98m+LWSjqXf1Tyep7oUOLToMTPZbCqE6HQIL1kp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.391.0/index.min.mjs": "sha384-BufXycHUB4+6mnFDa/BUJTAdR98m+LWSjqXf1Tyep7oUOLToMTPZbCqE6HQIL1kp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.391.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7UEwpbRFCGaHrFoeCW6VRVhh16jjKyJoO0OtUqtbG3yorPYJpecO+gQILd8lDUIu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.572.0/index.min.mjs": "sha384-7UEwpbRFCGaHrFoeCW6VRVhh16jjKyJoO0OtUqtbG3yorPYJpecO+gQILd8lDUIu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.572.0/LICENSE
```

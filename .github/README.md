...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h2SeGo56cFIrj5Ep/CLtYTuUNrNiIFRUXVfM+zQCmeRgUM1PGxuAJpqfrwpxanJw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.894.0/index.min.mjs": "sha384-h2SeGo56cFIrj5Ep/CLtYTuUNrNiIFRUXVfM+zQCmeRgUM1PGxuAJpqfrwpxanJw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.894.0/LICENSE
```

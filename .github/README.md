...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H/zbMY09OaYEEuLdo8gJLUuCMySzZKea6P+rlFt3t4Q2RK0BlVyqb031LLQmGqe6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.421.0/index.min.mjs": "sha384-H/zbMY09OaYEEuLdo8gJLUuCMySzZKea6P+rlFt3t4Q2RK0BlVyqb031LLQmGqe6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.421.0/LICENSE
```

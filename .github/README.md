...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K+tNRaPTpJiYZtxR1KoAcKp5V0FsbJfqUKkc+nqnrrkJZaqWWIJ3tlYNNEEdEqqz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.883.0/index.min.mjs": "sha384-K+tNRaPTpJiYZtxR1KoAcKp5V0FsbJfqUKkc+nqnrrkJZaqWWIJ3tlYNNEEdEqqz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.883.0/LICENSE
```

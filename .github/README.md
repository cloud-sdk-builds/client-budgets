...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CVrfTnmO6CbRx8W32JGUieyo1CvdfJQ9u/y//l7u+QLqirI04R4+cqifRUQcPQjQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.927.0/index.min.mjs": "sha384-CVrfTnmO6CbRx8W32JGUieyo1CvdfJQ9u/y//l7u+QLqirI04R4+cqifRUQcPQjQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.927.0/LICENSE
```

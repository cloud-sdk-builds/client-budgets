...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2b/BHuMqB62orpSIMvXAy31jP2JH/F4aPuiPxHzb+aTnQFFrTi733Ev+pss9Y+zm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.845.0/index.min.mjs": "sha384-2b/BHuMqB62orpSIMvXAy31jP2JH/F4aPuiPxHzb+aTnQFFrTi733Ev+pss9Y+zm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.845.0/LICENSE
```

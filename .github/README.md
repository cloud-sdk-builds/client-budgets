...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nUIwLC24pJU3rFm69R0AyPfRMtJVqznQVeYbP0sdUWW0+ufSZ/731BVU6XBVBeuQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.408.0/index.min.mjs": "sha384-nUIwLC24pJU3rFm69R0AyPfRMtJVqznQVeYbP0sdUWW0+ufSZ/731BVU6XBVBeuQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.408.0/LICENSE
```

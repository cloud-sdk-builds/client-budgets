...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7KfHzSq1aAwcgT3OEo5uEDi0GvsmL10MbMT1n4Q1M3s0pP2lFGZ7Y89FHaIjrB9Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.388.0/index.min.mjs": "sha384-7KfHzSq1aAwcgT3OEo5uEDi0GvsmL10MbMT1n4Q1M3s0pP2lFGZ7Y89FHaIjrB9Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.388.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yJ3XoFI2zDu6PbWLuLD1dnW9bTysdM3QmD8vIb24xVUlY7PW92u4+/9NI4Y+dXR1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.731.0/index.min.mjs": "sha384-yJ3XoFI2zDu6PbWLuLD1dnW9bTysdM3QmD8vIb24xVUlY7PW92u4+/9NI4Y+dXR1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.731.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-namN/21x4JtUoyBbLe2Bw+bfndjPGp0c4Gu/KijncbfG7ar3a6whP9KdTEL8cno9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.939.0/index.min.mjs": "sha384-namN/21x4JtUoyBbLe2Bw+bfndjPGp0c4Gu/KijncbfG7ar3a6whP9KdTEL8cno9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.939.0/LICENSE
```

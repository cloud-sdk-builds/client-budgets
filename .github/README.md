...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RqnAG7AgLCZQUe1Arlkaivv9zDnHeaiwd+z6aLhN4by5XAy4QCw3tP005xAAQOj1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.975.0/index.min.mjs": "sha384-RqnAG7AgLCZQUe1Arlkaivv9zDnHeaiwd+z6aLhN4by5XAy4QCw3tP005xAAQOj1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.975.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vOSpAl+6UFxE7r5Jj2vs02UjFd4hgtM2LssHFwj+hkUzVgd6pat0GLfrTVUwxCwc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.395.0/index.min.mjs": "sha384-vOSpAl+6UFxE7r5Jj2vs02UjFd4hgtM2LssHFwj+hkUzVgd6pat0GLfrTVUwxCwc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.395.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mcHJFLhmE1dalzHduekP30ZJ1WzzrCNExk3JcfVpf9qWH71yuOAKk2oRGgGGdHA9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.31.0/index.min.mjs": "sha384-mcHJFLhmE1dalzHduekP30ZJ1WzzrCNExk3JcfVpf9qWH71yuOAKk2oRGgGGdHA9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.31.0/LICENSE
```

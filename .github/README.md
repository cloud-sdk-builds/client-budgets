...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k7geRPzKpmlDO11Zxs8eym08uO9HORGjm8a5cSw61MeACHrq8jAwk8jZ9K1c908R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.67.0/index.min.mjs": "sha384-k7geRPzKpmlDO11Zxs8eym08uO9HORGjm8a5cSw61MeACHrq8jAwk8jZ9K1c908R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.67.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XwBTXTRL7q42Z3UFfHbNUGQX3dpXOTFnN5dOMWjaMDDU3xsRS6BNHJO35agZY2FD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.978.0/index.min.mjs": "sha384-XwBTXTRL7q42Z3UFfHbNUGQX3dpXOTFnN5dOMWjaMDDU3xsRS6BNHJO35agZY2FD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.978.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+thN20Redg0rroWizfwsnp2n6+ccL0r166VKf/HWYVShmqotJ7artEH+WmE3Z4oL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.998.0/index.min.mjs": "sha384-+thN20Redg0rroWizfwsnp2n6+ccL0r166VKf/HWYVShmqotJ7artEH+WmE3Z4oL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.998.0/LICENSE
```

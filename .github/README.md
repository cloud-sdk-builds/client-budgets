...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-74Gn0BpwFQJnGzqVs20I66UWVT13cnB+UGuH+iOjDQ/sro117mOoAI/fjJzLGS3C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.686.0/index.min.mjs": "sha384-74Gn0BpwFQJnGzqVs20I66UWVT13cnB+UGuH+iOjDQ/sro117mOoAI/fjJzLGS3C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.686.0/LICENSE
```

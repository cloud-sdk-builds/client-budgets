...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lHJKKL4p55+3mIu0k8mUB7/5FNXtAl/a8XdIVHLV0nWZCcXnB2JzQT+Odil/EfDy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.186.0/index.min.mjs": "sha384-lHJKKL4p55+3mIu0k8mUB7/5FNXtAl/a8XdIVHLV0nWZCcXnB2JzQT+Odil/EfDy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.186.0/LICENSE
```

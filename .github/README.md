...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bA2dl3vSVK4eJdoSaf3B977RzsPrkR6fzvTm8N86TyDSkGGWKKq9IxJckT+idN7E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.362.0/index.min.mjs": "sha384-bA2dl3vSVK4eJdoSaf3B977RzsPrkR6fzvTm8N86TyDSkGGWKKq9IxJckT+idN7E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.362.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DJHwlEQeHGBPf5HJHE063bUVx46FWxb7ucR0rOCwHE8Chj9CgrvUJD0rwVMy0EU4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.235.0/index.min.mjs": "sha384-DJHwlEQeHGBPf5HJHE063bUVx46FWxb7ucR0rOCwHE8Chj9CgrvUJD0rwVMy0EU4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.235.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QbTevDmDPHJd1PZJ6B/9Dn3dNiMCjxF5BiK8WnCDAIKJuu390EXyWKa4hwiqvi7B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.485.0/index.min.mjs": "sha384-QbTevDmDPHJd1PZJ6B/9Dn3dNiMCjxF5BiK8WnCDAIKJuu390EXyWKa4hwiqvi7B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.485.0/LICENSE
```

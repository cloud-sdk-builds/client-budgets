...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KlY6leO0XFGrxnQDGCrEw0VDMN0w06WAKq763D7WiuEfwYDGuV6HFVLIUkE/uma9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.598.0/index.min.mjs": "sha384-KlY6leO0XFGrxnQDGCrEw0VDMN0w06WAKq763D7WiuEfwYDGuV6HFVLIUkE/uma9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.598.0/LICENSE
```

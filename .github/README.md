...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zV1T/r2GjSTADvUbwYPNmQpvYMo0OM4XXmP7uUlrMyNPKZSy0IxwsB+cUVjcT6fI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.450.0/index.min.mjs": "sha384-zV1T/r2GjSTADvUbwYPNmQpvYMo0OM4XXmP7uUlrMyNPKZSy0IxwsB+cUVjcT6fI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.450.0/LICENSE
```

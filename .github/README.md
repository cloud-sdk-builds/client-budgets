...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gvTduNXY3gltOKaWxSDcExZfj25Wtxh3gj55fL6f4I4TnhA76CzI2qz6AewUbZu1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.258.0/index.min.mjs": "sha384-gvTduNXY3gltOKaWxSDcExZfj25Wtxh3gj55fL6f4I4TnhA76CzI2qz6AewUbZu1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.258.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TASTe4NFnpOVuUy0fUVPfKGy87sTVuK7lY+wRPo4DKYaIOcMdte91KpyCopoVhxK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.22.0/index.min.mjs": "sha384-TASTe4NFnpOVuUy0fUVPfKGy87sTVuK7lY+wRPo4DKYaIOcMdte91KpyCopoVhxK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.22.0/LICENSE
```

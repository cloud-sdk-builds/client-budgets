...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Spw5q8x4KY7qKavKMSIWQCPkU4EaRmq6EBHxkFsUiOY437fCaaToGvtI/RjXvtIl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.474.0/index.min.mjs": "sha384-Spw5q8x4KY7qKavKMSIWQCPkU4EaRmq6EBHxkFsUiOY437fCaaToGvtI/RjXvtIl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.474.0/LICENSE
```

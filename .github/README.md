...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bAwghfsm6YZ3FObxv9ersCbMqiDwPkDYSy5G6Obt0i1inGon/bp+2pr9xPCg11sO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.342.0/index.min.mjs": "sha384-bAwghfsm6YZ3FObxv9ersCbMqiDwPkDYSy5G6Obt0i1inGon/bp+2pr9xPCg11sO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.342.0/LICENSE
```

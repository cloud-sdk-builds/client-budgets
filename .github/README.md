...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.171.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.171.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xd0vdl7RKKEsDkEGR0EBp+VfsNoNWiTRXMOhwT7pelwhSeOK04ekouCgNwJ10ueJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.171.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.171.0/index.min.mjs": "sha384-xd0vdl7RKKEsDkEGR0EBp+VfsNoNWiTRXMOhwT7pelwhSeOK04ekouCgNwJ10ueJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.171.0/LICENSE
```

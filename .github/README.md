...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BPFmHwBeqv2Yc3HE4OnYu6lj9AaMJe27YR9LKBeDpr50btHr1GfImMkwcrU4cEzo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.911.0/index.min.mjs": "sha384-BPFmHwBeqv2Yc3HE4OnYu6lj9AaMJe27YR9LKBeDpr50btHr1GfImMkwcrU4cEzo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.911.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZEa7uwbeGbGR+jjym996yTKnkZX6rRhjCU4P8J453y1rhHWju9+6K/Px7PgI+Lj+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.8.0/index.min.mjs": "sha384-ZEa7uwbeGbGR+jjym996yTKnkZX6rRhjCU4P8J453y1rhHWju9+6K/Px7PgI+Lj+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.8.0/LICENSE
```

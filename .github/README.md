...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bpssBOPQ6o6OXynfEA82ojxMrCcRpkbQLfpWEd09B1SFLPdagZcGOlJRV3adAaKu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.79.0/index.min.mjs": "sha384-bpssBOPQ6o6OXynfEA82ojxMrCcRpkbQLfpWEd09B1SFLPdagZcGOlJRV3adAaKu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.79.0/LICENSE
```

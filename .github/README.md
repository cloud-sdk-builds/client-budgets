...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OOklxkks03/uMVTkKwu4mLt0FilTaor1HPAsrb+72wNS81vKMQ3UAX4eWKVjhGpv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.178.0/index.min.mjs": "sha384-OOklxkks03/uMVTkKwu4mLt0FilTaor1HPAsrb+72wNS81vKMQ3UAX4eWKVjhGpv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.178.0/LICENSE
```

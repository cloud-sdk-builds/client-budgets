...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5ozPCzKbpvJpbL9dVUNQwCXsOt7zPf4Ts5vWgrmKx4wz8QU8Gxg9YA9pMlEDyYQW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.932.0/index.min.mjs": "sha384-5ozPCzKbpvJpbL9dVUNQwCXsOt7zPf4Ts5vWgrmKx4wz8QU8Gxg9YA9pMlEDyYQW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.932.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0lQKtMG/MpE987rY/rGt+OM5QBFfr6+f2C7hSSSrtW/GL0p0CHuucE/WxW5CU/Ev
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.879.0/index.min.mjs": "sha384-0lQKtMG/MpE987rY/rGt+OM5QBFfr6+f2C7hSSSrtW/GL0p0CHuucE/WxW5CU/Ev"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.879.0/LICENSE
```

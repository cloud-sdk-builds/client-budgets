...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NaNR1RtlhjXo8kkhYqcbspDHG7C8HTDiASADqL2sqlcmvVUBYCWuTitKo2UqmguF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.112.0/index.min.mjs": "sha384-NaNR1RtlhjXo8kkhYqcbspDHG7C8HTDiASADqL2sqlcmvVUBYCWuTitKo2UqmguF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.112.0/LICENSE
```

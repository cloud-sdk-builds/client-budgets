...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J3IkIBTEY8gAfsPLZhDApcVuvD/Z7rcMbid0cFNs+UPTljVmt5GrWf2vFb6uEyNk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.341.0/index.min.mjs": "sha384-J3IkIBTEY8gAfsPLZhDApcVuvD/Z7rcMbid0cFNs+UPTljVmt5GrWf2vFb6uEyNk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.341.0/LICENSE
```

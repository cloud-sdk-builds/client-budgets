...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vysUaJDVGUS0A/F5awCYJjQVwKYb40ExOxR77wQnxH+70ZhsTfywqjw4Cd7CG43h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.629.0/index.min.mjs": "sha384-vysUaJDVGUS0A/F5awCYJjQVwKYb40ExOxR77wQnxH+70ZhsTfywqjw4Cd7CG43h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.629.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V58Ye5QTJF6dBJglLU5Mz4BxH/jYcZkgxOUqnDKBsukrjRFmOrc+9T8ATfpxnP57
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.616.0/index.min.mjs": "sha384-V58Ye5QTJF6dBJglLU5Mz4BxH/jYcZkgxOUqnDKBsukrjRFmOrc+9T8ATfpxnP57"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.616.0/LICENSE
```

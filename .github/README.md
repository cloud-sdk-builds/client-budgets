...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M5WXUP5raNQZCeuM98DwvYuzobK3mabl/45RvAHNKZADJi9lsteriYSYKDbgX1La
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.521.0/index.min.mjs": "sha384-M5WXUP5raNQZCeuM98DwvYuzobK3mabl/45RvAHNKZADJi9lsteriYSYKDbgX1La"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.521.0/LICENSE
```

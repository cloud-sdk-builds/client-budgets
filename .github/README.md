...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ATFkGu4cKL6pSJ7FcTr9wHXDTy/OhznbDYJwy8CKif6ZsEadEdMbwbYDLZyfbdTJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.983.0/index.min.mjs": "sha384-ATFkGu4cKL6pSJ7FcTr9wHXDTy/OhznbDYJwy8CKif6ZsEadEdMbwbYDLZyfbdTJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.983.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JQ6XaokCMtAvp0eJjNteL7ZaDwe5e+/LVfPsgf3UmuXhmbDO12yq0a1192vbs771
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.245.0/index.min.mjs": "sha384-JQ6XaokCMtAvp0eJjNteL7ZaDwe5e+/LVfPsgf3UmuXhmbDO12yq0a1192vbs771"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.245.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Oa4dDKd7hET/t2xFxghZhJ021Qj/fNxzY+6LULEvCVWNvwlcHEB468ZGcsmnLSIQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.201.0/index.min.mjs": "sha384-Oa4dDKd7hET/t2xFxghZhJ021Qj/fNxzY+6LULEvCVWNvwlcHEB468ZGcsmnLSIQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.201.0/LICENSE
```

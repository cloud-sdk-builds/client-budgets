...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1006.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1006.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ao3+lbXJSKKeEz9nWlQm/33rice4rgoTJmSCU4BVp4J2kC3AllzpDLZM4lMQ7VyW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1006.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1006.0/index.min.mjs": "sha384-ao3+lbXJSKKeEz9nWlQm/33rice4rgoTJmSCU4BVp4J2kC3AllzpDLZM4lMQ7VyW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1006.0/LICENSE
```

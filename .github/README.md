...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xLmkVfqBxD0zw+EOg8otqVCRr/X1EeQBNVNaaJ/Z19Qoo3AmRWjfnm3F7HoX1LFC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1041.0/index.min.mjs": "sha384-xLmkVfqBxD0zw+EOg8otqVCRr/X1EeQBNVNaaJ/Z19Qoo3AmRWjfnm3F7HoX1LFC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1041.0/LICENSE
```

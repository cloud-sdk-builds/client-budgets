...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lGvlfBrKY/9X47Va6l3v5qA+hY1rIit5uoe6WURxAtS+X1SFJ4BIEImED0otgLLP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.30.0/index.min.mjs": "sha384-lGvlfBrKY/9X47Va6l3v5qA+hY1rIit5uoe6WURxAtS+X1SFJ4BIEImED0otgLLP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.30.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G2m2vc8fRgmDim6eyOXLDe0Uzv5udgOiY8AW/6hDnQgDqzjlNY7kKZh9c5PcDuBz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.556.0/index.min.mjs": "sha384-G2m2vc8fRgmDim6eyOXLDe0Uzv5udgOiY8AW/6hDnQgDqzjlNY7kKZh9c5PcDuBz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.556.0/LICENSE
```

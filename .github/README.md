...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dZ4V7z0cpcpGLej8aCRdvAOoIlVfuydez3dakRmavL4LgHwtuQ9vd2pILuA4japH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.895.0/index.min.mjs": "sha384-dZ4V7z0cpcpGLej8aCRdvAOoIlVfuydez3dakRmavL4LgHwtuQ9vd2pILuA4japH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.895.0/LICENSE
```

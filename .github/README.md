...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KGPVtMU8z7eOtqAVA8EcB01Pw7rn9qoYGHVw5ea5Y9+00gYdi5xI1OhMN0CuciIB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.431.0/index.min.mjs": "sha384-KGPVtMU8z7eOtqAVA8EcB01Pw7rn9qoYGHVw5ea5Y9+00gYdi5xI1OhMN0CuciIB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.431.0/LICENSE
```

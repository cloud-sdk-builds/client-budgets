...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T7Ny2yxS8W61CwuO/krEyra/00ISVBoky8dq+tgjPX77RhFnRKEGOHa/Jp9T4Wh9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.635.0/index.min.mjs": "sha384-T7Ny2yxS8W61CwuO/krEyra/00ISVBoky8dq+tgjPX77RhFnRKEGOHa/Jp9T4Wh9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.635.0/LICENSE
```

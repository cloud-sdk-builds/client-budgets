...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LQBe5k0yhlCZWKM5DcaKhZapXRX1oX/L3rzB9jyTJ7xDSHcQB+wcbwfcfj5moXap
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.991.0/index.min.mjs": "sha384-LQBe5k0yhlCZWKM5DcaKhZapXRX1oX/L3rzB9jyTJ7xDSHcQB+wcbwfcfj5moXap"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.991.0/LICENSE
```

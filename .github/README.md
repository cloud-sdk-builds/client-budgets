...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xfq0T2jjLCHlOdjlj+GPpgZPOklzDiDf+yZdbyL4ae7vnsAhxRHst9NUebHr8R15
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.896.0/index.min.mjs": "sha384-xfq0T2jjLCHlOdjlj+GPpgZPOklzDiDf+yZdbyL4ae7vnsAhxRHst9NUebHr8R15"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.896.0/LICENSE
```

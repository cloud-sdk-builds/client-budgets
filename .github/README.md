...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FyyUmUex9oapcySa6vItMgDNCDGELCxkO02T+OT+/QgJPxH+kJVPowyzcEFZeJyM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.533.0/index.min.mjs": "sha384-FyyUmUex9oapcySa6vItMgDNCDGELCxkO02T+OT+/QgJPxH+kJVPowyzcEFZeJyM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.533.0/LICENSE
```

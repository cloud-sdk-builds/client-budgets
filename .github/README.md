...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.13.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.13.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LaxiujVgWFsf27KCJy1na9KjOkB0rJQKpsktKqU7TV8pfkcRiTJbqlnOiLjm13ng
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.13.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.13.0/index.min.mjs": "sha384-LaxiujVgWFsf27KCJy1na9KjOkB0rJQKpsktKqU7TV8pfkcRiTJbqlnOiLjm13ng"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.13.0/LICENSE
```

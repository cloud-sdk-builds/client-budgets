...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nziY3/o/50/DKYPh1/rh+aquD5raEHm5OBheQC6zztS5uXfQ0m41V8FRMaXHUyiK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.514.0/index.min.mjs": "sha384-nziY3/o/50/DKYPh1/rh+aquD5raEHm5OBheQC6zztS5uXfQ0m41V8FRMaXHUyiK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.514.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4DjzkX0l/wRKTJizPbu/ZIsZjLUcQE3ICUJfmqWNE7ftJYX4ueOlc7i6DBPIDeYg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.48.0/index.min.mjs": "sha384-4DjzkX0l/wRKTJizPbu/ZIsZjLUcQE3ICUJfmqWNE7ftJYX4ueOlc7i6DBPIDeYg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.48.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bqlsXwSG3Zxh7dCJNcg0royGSQ+e9omawSP21DkGHigjPWAXtZ0U172HGo9xNbaG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.128.0/index.min.mjs": "sha384-bqlsXwSG3Zxh7dCJNcg0royGSQ+e9omawSP21DkGHigjPWAXtZ0U172HGo9xNbaG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.128.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2xhVUaQsUE+UpnR9aL9adDVPps+K+kR+kEpq1Pxss2TcvxtANxC3xmX7XwtFoo8y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.425.0/index.min.mjs": "sha384-2xhVUaQsUE+UpnR9aL9adDVPps+K+kR+kEpq1Pxss2TcvxtANxC3xmX7XwtFoo8y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.425.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RA9uPd6hzsDj5SvnwFsXhWWy890n4s8fTk3SFbxSx5fs+tZYvyrQ9Bnv7eEPcZPB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.398.0/index.min.mjs": "sha384-RA9uPd6hzsDj5SvnwFsXhWWy890n4s8fTk3SFbxSx5fs+tZYvyrQ9Bnv7eEPcZPB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.398.0/LICENSE
```

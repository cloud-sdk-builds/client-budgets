...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.923.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.923.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p/lQ/KjJ2qbYodGApCNCTHY+n4AZTZO4vSklCSWxyCWW4kTAAkekupDHiEw1ndd9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.923.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.923.0/index.min.mjs": "sha384-p/lQ/KjJ2qbYodGApCNCTHY+n4AZTZO4vSklCSWxyCWW4kTAAkekupDHiEw1ndd9"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.923.0`)
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.923.0/LICENSE
```

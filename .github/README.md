...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oGv/w/NQzl7/DqS/tdFSRsmh06fOowzRKriWMOz0hBy6vuq0M3TnvtjEwZn4Y3Uv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.890.0/index.min.mjs": "sha384-oGv/w/NQzl7/DqS/tdFSRsmh06fOowzRKriWMOz0hBy6vuq0M3TnvtjEwZn4Y3Uv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.890.0/LICENSE
```

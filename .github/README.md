...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VCPwn6YY6Wwxiku8qYuhwZgAV6oV/+2xgkb3IMAFbl1liV4QGJVbZG4JNol4aQi+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.0.0/index.min.mjs": "sha384-VCPwn6YY6Wwxiku8qYuhwZgAV6oV/+2xgkb3IMAFbl1liV4QGJVbZG4JNol4aQi+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.0.0/LICENSE
```

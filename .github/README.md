...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YTO84BJuzD97zyAmap9qWpERb+lYT2Xzcs/tGC5dgL1hLuwcmrJgzjmjZP64KBG3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.445.0/index.min.mjs": "sha384-YTO84BJuzD97zyAmap9qWpERb+lYT2Xzcs/tGC5dgL1hLuwcmrJgzjmjZP64KBG3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.445.0/LICENSE
```

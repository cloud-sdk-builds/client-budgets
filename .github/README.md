...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-saOS0QZ60I05qvgBv4tZF5tuP7kF6RyrfYQnNcEKHxbLR9OMHHnlqz+9z+ZuBG5f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.501.0/index.min.mjs": "sha384-saOS0QZ60I05qvgBv4tZF5tuP7kF6RyrfYQnNcEKHxbLR9OMHHnlqz+9z+ZuBG5f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.501.0/LICENSE
```

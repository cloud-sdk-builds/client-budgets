...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8sdLyhhvI+jpcOLnQyk3o6W8dvEwi2hil1bFejwjjSSSwQhUolt7w38f3OEsNgbr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.721.0/index.min.mjs": "sha384-8sdLyhhvI+jpcOLnQyk3o6W8dvEwi2hil1bFejwjjSSSwQhUolt7w38f3OEsNgbr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.721.0/LICENSE
```

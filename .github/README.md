...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tXbEZ+LcoVD4OlUv+YlJbEL8n5Ri61LCNzk2Yb0t6/VLjIQegJu7Gre3QYCHTPdH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.774.0/index.min.mjs": "sha384-tXbEZ+LcoVD4OlUv+YlJbEL8n5Ri61LCNzk2Yb0t6/VLjIQegJu7Gre3QYCHTPdH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.774.0/LICENSE
```

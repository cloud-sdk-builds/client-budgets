...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AMx9Jd68UCzsZ4Ln4hfVuuXNAkmXrc9MmntukQYCgjxs+Du1gic67DDorXu62BTg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.354.0/index.min.mjs": "sha384-AMx9Jd68UCzsZ4Ln4hfVuuXNAkmXrc9MmntukQYCgjxs+Du1gic67DDorXu62BTg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.354.0/LICENSE
```

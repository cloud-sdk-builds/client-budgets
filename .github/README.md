...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q59GYzv5h4REUIeezRLPp/tQeMwI5gjiORYQFkDdKw8Yetoud3kU7D/lsb9H3QFf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.936.0/index.min.mjs": "sha384-q59GYzv5h4REUIeezRLPp/tQeMwI5gjiORYQFkDdKw8Yetoud3kU7D/lsb9H3QFf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.936.0/LICENSE
```

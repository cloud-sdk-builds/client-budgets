...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lNwXQPLIeN4tWhRCYD/tYx+cakfuG5n7lw2UCRwirV8bipX6UWARzUPHNS/vq60y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.523.0/index.min.mjs": "sha384-lNwXQPLIeN4tWhRCYD/tYx+cakfuG5n7lw2UCRwirV8bipX6UWARzUPHNS/vq60y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.523.0/LICENSE
```

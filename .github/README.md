...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0tW+dNH2yi0u39YarW+pOocXRQ6kW0+qhev5NJoezhXKYW4l57HKqBqHdgPvvV8V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.995.0/index.min.mjs": "sha384-0tW+dNH2yi0u39YarW+pOocXRQ6kW0+qhev5NJoezhXKYW4l57HKqBqHdgPvvV8V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.995.0/LICENSE
```

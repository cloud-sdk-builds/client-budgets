...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TAo8VELqPcDNYj3Pisn2f7vMBmlEyysCcX1AWIyWJf7j7HLU6EH2iIwAX7oqi1dR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.141.0/index.min.mjs": "sha384-TAo8VELqPcDNYj3Pisn2f7vMBmlEyysCcX1AWIyWJf7j7HLU6EH2iIwAX7oqi1dR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.141.0/LICENSE
```

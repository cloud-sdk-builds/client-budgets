...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0VXC38Zadw2SKUwfz00QJZ75DLzLSaUnmXJlP+JXenILfsr9GMyOVgCAaLdxkfcc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.386.0/index.min.mjs": "sha384-0VXC38Zadw2SKUwfz00QJZ75DLzLSaUnmXJlP+JXenILfsr9GMyOVgCAaLdxkfcc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.386.0/LICENSE
```

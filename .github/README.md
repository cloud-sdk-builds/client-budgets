...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uR4CLn/5kGeZsF0nrFw1DOWDoT5+oWSPIC6nMYX5zXLHfudiSpO2VeVMehuvCr7q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.325.0/index.min.mjs": "sha384-uR4CLn/5kGeZsF0nrFw1DOWDoT5+oWSPIC6nMYX5zXLHfudiSpO2VeVMehuvCr7q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.325.0/LICENSE
```

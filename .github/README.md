...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AkiS3bQOjcIJodTC0ggfYQcXqgBdqKQV4MitTHSn/NS63WZY9zXDFWX5A4sd4vKv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.295.0/index.min.mjs": "sha384-AkiS3bQOjcIJodTC0ggfYQcXqgBdqKQV4MitTHSn/NS63WZY9zXDFWX5A4sd4vKv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.295.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZOV1CqOulVeEf/eUn2MDtpgyvo4HZKS3FkffF22Jo8YEEHBs2LSzMdQ12PtjUcKp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.303.0/index.min.mjs": "sha384-ZOV1CqOulVeEf/eUn2MDtpgyvo4HZKS3FkffF22Jo8YEEHBs2LSzMdQ12PtjUcKp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.303.0/LICENSE
```

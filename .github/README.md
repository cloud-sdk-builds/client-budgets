...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YtwatPgqKqgPBt3dIasH4KPbLjZik/QbehbuWJqaKb+uQxAzXnCYJ2dGqHSkVD6j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.857.0/index.min.mjs": "sha384-YtwatPgqKqgPBt3dIasH4KPbLjZik/QbehbuWJqaKb+uQxAzXnCYJ2dGqHSkVD6j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.857.0/LICENSE
```

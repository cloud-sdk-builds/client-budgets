...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/snS+OE6/l8qIBwfvg4eR51bs2XhLSiS2RtEdgzOgElaGppeyr+iqo2UKYddenCn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.587.0/index.min.mjs": "sha384-/snS+OE6/l8qIBwfvg4eR51bs2XhLSiS2RtEdgzOgElaGppeyr+iqo2UKYddenCn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.587.0/LICENSE
```

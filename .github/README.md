...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z7KjyYEEH8K+BRWXs/mntvWMdIxO3HNV0MsOYhrPDZHweRE5N5ozTEvn2ahv7lCK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.970.0/index.min.mjs": "sha384-Z7KjyYEEH8K+BRWXs/mntvWMdIxO3HNV0MsOYhrPDZHweRE5N5ozTEvn2ahv7lCK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.970.0/LICENSE
```

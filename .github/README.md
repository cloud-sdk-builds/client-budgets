...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pKwlu+m2fSOlS6WCcP2AH8YmOFa1sR4tC0T3zc5YED911Kg3vfULXJFjkNDvk4ra
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.347.0/index.min.mjs": "sha384-pKwlu+m2fSOlS6WCcP2AH8YmOFa1sR4tC0T3zc5YED911Kg3vfULXJFjkNDvk4ra"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.347.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.7.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-moLMDZ/t/8NFaVlpDYVhWHEoiQBDN6oBtpdK8w7p/t13FLMf3yL0kWrdMzS09PvI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.7.0/index.min.mjs": "sha384-moLMDZ/t/8NFaVlpDYVhWHEoiQBDN6oBtpdK8w7p/t13FLMf3yL0kWrdMzS09PvI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.7.0/LICENSE
```

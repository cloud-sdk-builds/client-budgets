...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a6Al5eLiJ7najwOm/4//Q9kxlJtv9RnzLcxfmLePmkJ/KQ8o6OJ0mM9nu2DlfUwO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.316.0/index.min.mjs": "sha384-a6Al5eLiJ7najwOm/4//Q9kxlJtv9RnzLcxfmLePmkJ/KQ8o6OJ0mM9nu2DlfUwO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.316.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oPImrpd4YZvpIyVp7pNY5NrjCq5wWewyOeHWmn9qHAVmPAqWhiCfWuafsUmo6JJz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.25.0/index.min.mjs": "sha384-oPImrpd4YZvpIyVp7pNY5NrjCq5wWewyOeHWmn9qHAVmPAqWhiCfWuafsUmo6JJz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.25.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-/ugcasjqy7M/+6P+GyAhYk3rgmhMgXsJVEpH4v6Jk4k1VGGHHlmOyf7zTDg/FOMm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.54.1/index.min.mjs": "sha384-/ugcasjqy7M/+6P+GyAhYk3rgmhMgXsJVEpH4v6Jk4k1VGGHHlmOyf7zTDg/FOMm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.54.1/LICENSE
```

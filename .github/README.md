...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T2CHI65rQdQKI/wICX6s1qHlkeMEKPjIv7s8HD0IZDzYyBzXdNzKL0O8bccd+ZLo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.282.0/index.min.mjs": "sha384-T2CHI65rQdQKI/wICX6s1qHlkeMEKPjIv7s8HD0IZDzYyBzXdNzKL0O8bccd+ZLo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.282.0/LICENSE
```

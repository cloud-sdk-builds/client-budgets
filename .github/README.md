...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v6+TUrxbrwA0rTCaGN1F0bCZcy4qDb7hGW0GhXZVnMB0TRX9vSmd1sp6ogsz5fVg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.49.0/index.min.mjs": "sha384-v6+TUrxbrwA0rTCaGN1F0bCZcy4qDb7hGW0GhXZVnMB0TRX9vSmd1sp6ogsz5fVg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.49.0/LICENSE
```

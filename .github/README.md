...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JbUwI+z6a/x/y8TwttuhB7+jnsiDqi0+yF/qLShiZxYzJvFGuV6LrGze7UH0F/YL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.986.0/index.min.mjs": "sha384-JbUwI+z6a/x/y8TwttuhB7+jnsiDqi0+yF/qLShiZxYzJvFGuV6LrGze7UH0F/YL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.986.0/LICENSE
```

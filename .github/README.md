...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j5UoQ+VuZgOADh9SyZ977RpAcfa3xQbtKJE2jVMN4AOI/tA60sPv/3st6VdWgCxx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.200.0/index.min.mjs": "sha384-j5UoQ+VuZgOADh9SyZ977RpAcfa3xQbtKJE2jVMN4AOI/tA60sPv/3st6VdWgCxx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.200.0/LICENSE
```

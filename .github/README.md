...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bK8OkMXwVW6QXA/na+VZhxUGBuNk4UKlT7oqxX0i8Kmvy8UTgxQbTtbqPu8uwP6m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.75.0/index.min.mjs": "sha384-bK8OkMXwVW6QXA/na+VZhxUGBuNk4UKlT7oqxX0i8Kmvy8UTgxQbTtbqPu8uwP6m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.75.0/LICENSE
```

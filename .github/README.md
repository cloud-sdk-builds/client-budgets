...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f92kId0rFD4k/kgnLatlcqZPviTooPtSH7gKK8HBu2syk1Z4aHk1oq3vULyQyz5X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.499.0/index.min.mjs": "sha384-f92kId0rFD4k/kgnLatlcqZPviTooPtSH7gKK8HBu2syk1Z4aHk1oq3vULyQyz5X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.499.0/LICENSE
```

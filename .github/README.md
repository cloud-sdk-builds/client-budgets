...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1MghEvnmsTgUq2LfepFLdBRv+IUUJyv8l4N0m5V+66Wem3UUy5oaC2a5CDxEWuKe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.288.0/index.min.mjs": "sha384-1MghEvnmsTgUq2LfepFLdBRv+IUUJyv8l4N0m5V+66Wem3UUy5oaC2a5CDxEWuKe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.288.0/LICENSE
```

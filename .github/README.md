...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1008.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1008.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N31FYuXFPTxIm78RU3Sp9i3we9EBKljHp0z9rD8GI4qudl8XPVdrMUOkriW6+AWe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1008.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1008.0/index.min.mjs": "sha384-N31FYuXFPTxIm78RU3Sp9i3we9EBKljHp0z9rD8GI4qudl8XPVdrMUOkriW6+AWe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1008.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-gdIAsDpHJskLqBzv9d50JN2ePOVRxaL50SFgdb0pC41WZ0xK7Df96+nyc8KFaXVe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.651.1/index.min.mjs": "sha384-gdIAsDpHJskLqBzv9d50JN2ePOVRxaL50SFgdb0pC41WZ0xK7Df96+nyc8KFaXVe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.651.1/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K8aTiFlchiT9XNM88KHKMrfMNb0AV0LsGYCoppfoSHpjjZmThoLB3IYYci0vonsn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.55.0/index.min.mjs": "sha384-K8aTiFlchiT9XNM88KHKMrfMNb0AV0LsGYCoppfoSHpjjZmThoLB3IYYci0vonsn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.55.0/LICENSE
```

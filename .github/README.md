...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mlRa3GvpKtGaFHJRTTjlOq954xBF+pn7hoPcm66RIXMkRmbk19moZrtSbKxIv00U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.387.0/index.min.mjs": "sha384-mlRa3GvpKtGaFHJRTTjlOq954xBF+pn7hoPcm66RIXMkRmbk19moZrtSbKxIv00U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.387.0/LICENSE
```

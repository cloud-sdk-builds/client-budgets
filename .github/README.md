...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WkHeusphwxw8Rh08ieANtIGtWsbxNLRF/cbOg7bAZ15aKcqAKWb9JpXzXnKD7PuX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.956.0/index.min.mjs": "sha384-WkHeusphwxw8Rh08ieANtIGtWsbxNLRF/cbOg7bAZ15aKcqAKWb9JpXzXnKD7PuX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.956.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SaO/cAOZwKXyQhoX5q0mTt0fJpcx+Mo6pFCDOnBD68R/SMfWcU80/OLn3nqwVqL2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.335.0/index.min.mjs": "sha384-SaO/cAOZwKXyQhoX5q0mTt0fJpcx+Mo6pFCDOnBD68R/SMfWcU80/OLn3nqwVqL2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.335.0/LICENSE
```

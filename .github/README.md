...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w2GjrUXSy6tU0ZTiM04NvDUns70BmAae/klyQT8zrzgm0CwbfiZnXgSoQcQLJw4P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.738.0/index.min.mjs": "sha384-w2GjrUXSy6tU0ZTiM04NvDUns70BmAae/klyQT8zrzgm0CwbfiZnXgSoQcQLJw4P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.738.0/LICENSE
```

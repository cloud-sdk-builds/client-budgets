...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1032.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1032.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qp0800cMZd/yui0J0paWlYda6ZBzOjz6kwoyTZvxpqyakl9+V9xNWBUPyjqUjNNC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1032.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1032.0/index.min.mjs": "sha384-Qp0800cMZd/yui0J0paWlYda6ZBzOjz6kwoyTZvxpqyakl9+V9xNWBUPyjqUjNNC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1032.0/LICENSE
```

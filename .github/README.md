...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dc9FhHH/lnGeZ3/SQZ68OUmnRrqv3Xt6PM1xd6xqs0lHVn8qqNTOAGvIMJAzmdty
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.105.0/index.min.mjs": "sha384-dc9FhHH/lnGeZ3/SQZ68OUmnRrqv3Xt6PM1xd6xqs0lHVn8qqNTOAGvIMJAzmdty"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.105.0/LICENSE
```

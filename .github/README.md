...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iq37EORaKYwFqWSvHcbvctzUO7/85LxAASWUPFl1UUCRo+8EBYkdW+Z3iq8UpEwj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.26.0/index.min.mjs": "sha384-iq37EORaKYwFqWSvHcbvctzUO7/85LxAASWUPFl1UUCRo+8EBYkdW+Z3iq8UpEwj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.26.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.306.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.306.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vDl+pfUy0CGHKUT6Hgn49FhdMXuJq1oftWGJlc5JyhzVoOfAG3pu2QPQPtw81ZlO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.306.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.306.0/index.min.mjs": "sha384-vDl+pfUy0CGHKUT6Hgn49FhdMXuJq1oftWGJlc5JyhzVoOfAG3pu2QPQPtw81ZlO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.306.0/LICENSE
```

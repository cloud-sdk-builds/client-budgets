...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.1024.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1024.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rNFJ06k2GQrBcFEiGB4VuN9VxGfh3e+WNmMZhkMb0vQ+cZUWiiZyo6s4IG+65E9l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1024.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.1024.0/index.min.mjs": "sha384-rNFJ06k2GQrBcFEiGB4VuN9VxGfh3e+WNmMZhkMb0vQ+cZUWiiZyo6s4IG+65E9l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.1024.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3yImTGwazy6u3vSYL0KgdMe/oCZDTPmmP6cDgtLI/Yu6sicLEX4mkY0VonUjEtdi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.293.0/index.min.mjs": "sha384-3yImTGwazy6u3vSYL0KgdMe/oCZDTPmmP6cDgtLI/Yu6sicLEX4mkY0VonUjEtdi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.293.0/LICENSE
```

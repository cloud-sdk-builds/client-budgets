...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-psAEgw2CgP4ZZgIldNb9g3/QoEYds37DmiM5tuK5Chv0aho2JFr0tDOs4/5iJmSE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.918.0/index.min.mjs": "sha384-psAEgw2CgP4ZZgIldNb9g3/QoEYds37DmiM5tuK5Chv0aho2JFr0tDOs4/5iJmSE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.918.0/LICENSE
```

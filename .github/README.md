...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K15QsGrXa8rU7vnYbKulQ5yoKmbul25jRsKLxZclYNkaJLfM4tGiKFFFUq5iiwRH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.730.0/index.min.mjs": "sha384-K15QsGrXa8rU7vnYbKulQ5yoKmbul25jRsKLxZclYNkaJLfM4tGiKFFFUq5iiwRH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.730.0/LICENSE
```

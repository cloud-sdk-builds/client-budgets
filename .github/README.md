...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.215.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.215.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0uG6U/ms0bOTk7TAJase//s2kfYPdHNCIgTKOMmjW4Se/oFEOX5OPpelz5tCbkRe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.215.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.215.0/index.min.mjs": "sha384-0uG6U/ms0bOTk7TAJase//s2kfYPdHNCIgTKOMmjW4Se/oFEOX5OPpelz5tCbkRe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.215.0/LICENSE
```

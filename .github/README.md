...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yBc8H34wmCWGv6h/jIxMhgPf1kb23Pw4JkJB86jsDGjYmbgA1F3MBh2nZRCInLNm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.667.0/index.min.mjs": "sha384-yBc8H34wmCWGv6h/jIxMhgPf1kb23Pw4JkJB86jsDGjYmbgA1F3MBh2nZRCInLNm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.667.0/LICENSE
```

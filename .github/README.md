...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8z14l2Dj+jRl/olwjuLjojcPyAwMmYvQa33K+OHURi/oPVzdhBSrH3suclOs3Uhi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.919.0/index.min.mjs": "sha384-8z14l2Dj+jRl/olwjuLjojcPyAwMmYvQa33K+OHURi/oPVzdhBSrH3suclOs3Uhi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.919.0/LICENSE
```

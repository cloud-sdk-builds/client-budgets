...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EEbytYBqb/xlpTF/Q9U9hApNStgVWNRrP8C5vin+Bt1cPct1MJvCADxHeC4KoKmD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.72.0/index.min.mjs": "sha384-EEbytYBqb/xlpTF/Q9U9hApNStgVWNRrP8C5vin+Bt1cPct1MJvCADxHeC4KoKmD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.72.0/LICENSE
```

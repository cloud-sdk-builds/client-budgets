...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2rX7Z8TlGiK8G9s2x/pXbfT5Vxa/inCDDQ3jLHKJeLdjsQkmn8uy4ZQNVQbPM8Sn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.966.0/index.min.mjs": "sha384-2rX7Z8TlGiK8G9s2x/pXbfT5Vxa/inCDDQ3jLHKJeLdjsQkmn8uy4ZQNVQbPM8Sn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.966.0/LICENSE
```

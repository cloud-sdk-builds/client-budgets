...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.840.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.840.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-srePun7+h0JiZf28G1G22IbeT0abV2woG1paxVm5YW6fo47HKFaataERBBoJmk7L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.840.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.840.0/index.min.mjs": "sha384-srePun7+h0JiZf28G1G22IbeT0abV2woG1paxVm5YW6fo47HKFaataERBBoJmk7L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.840.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WfYA3ev9jErXhpP3Fa0zDBgQZ5swbGCWGAKhVdTv/wYCNVMCAc6zdSFa6N3HaLEf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.348.0/index.min.mjs": "sha384-WfYA3ev9jErXhpP3Fa0zDBgQZ5swbGCWGAKhVdTv/wYCNVMCAc6zdSFa6N3HaLEf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.348.0/LICENSE
```

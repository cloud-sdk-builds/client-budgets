...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s+8GPnUfRcTC0iofXZl+6i7CMZFzeGAZxFx0c8G9EwNm6inpyZMMPTg7PxIuW3cR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.816.0/index.min.mjs": "sha384-s+8GPnUfRcTC0iofXZl+6i7CMZFzeGAZxFx0c8G9EwNm6inpyZMMPTg7PxIuW3cR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.816.0/LICENSE
```

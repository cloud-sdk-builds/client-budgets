...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.238.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.238.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DBP9lijZTItGa8Y0EZobKxL3j1FZ/1KjJhl9BqI3G4wIxqSwAObjB7tzAgME7NZt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.238.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.238.0/index.min.mjs": "sha384-DBP9lijZTItGa8Y0EZobKxL3j1FZ/1KjJhl9BqI3G4wIxqSwAObjB7tzAgME7NZt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.238.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TmmCocHBj9dVa/N4gi+TlKgmWpoH63h0OtXXMZ4SqC+b6dwZ9rW50aZffSmNquhj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.150.0/index.min.mjs": "sha384-TmmCocHBj9dVa/N4gi+TlKgmWpoH63h0OtXXMZ4SqC+b6dwZ9rW50aZffSmNquhj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.150.0/LICENSE
```

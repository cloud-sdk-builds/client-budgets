...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5PUuSGMyJFNkpc1NEbpfJdsHHe5PaTIe3EEt0gKjgH2kupwC3EjsgzMNtGRGascw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.675.0/index.min.mjs": "sha384-5PUuSGMyJFNkpc1NEbpfJdsHHe5PaTIe3EEt0gKjgH2kupwC3EjsgzMNtGRGascw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.675.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lBWpNjBJJX4Hwr6B8Rz49XJVp+T0WhZs8CA1YO8oyKsm8oTTKHM+1kPKf2ECYVwV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.590.0/index.min.mjs": "sha384-lBWpNjBJJX4Hwr6B8Rz49XJVp+T0WhZs8CA1YO8oyKsm8oTTKHM+1kPKf2ECYVwV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.590.0/LICENSE
```

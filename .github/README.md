...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YKcv3BOtFJh/nJ+Mg3XpSurnbSTNCz5gZz+hjBqw1ZnvD3loamUaUAqu7aD+dDOp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.9.0/index.min.mjs": "sha384-YKcv3BOtFJh/nJ+Mg3XpSurnbSTNCz5gZz+hjBqw1ZnvD3loamUaUAqu7aD+dDOp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.9.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.262.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.262.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C38rJR9iw8oRhcnouC+owaz4C/1gAtu/eWs1PTR/rp9Y/w6pkgGJqbgy/pIlHrHs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.262.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.262.0/index.min.mjs": "sha384-C38rJR9iw8oRhcnouC+owaz4C/1gAtu/eWs1PTR/rp9Y/w6pkgGJqbgy/pIlHrHs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.262.0/LICENSE
```

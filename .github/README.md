...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ywjeIjxMU6EfiKX2wmX/ncpAPRs5HpV2RhUVON7HlyUaZ0Cm1htwT/1HUe6ib7Kd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.131.0/index.min.mjs": "sha384-ywjeIjxMU6EfiKX2wmX/ncpAPRs5HpV2RhUVON7HlyUaZ0Cm1htwT/1HUe6ib7Kd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.131.0/LICENSE
```

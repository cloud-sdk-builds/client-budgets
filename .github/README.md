...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KfJr3t6cOdNGToGUSij6kL2sjecV4rN0JN/JS1EO8J/zjncsgCRpKM5iJ7qJfAEz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.606.0/index.min.mjs": "sha384-KfJr3t6cOdNGToGUSij6kL2sjecV4rN0JN/JS1EO8J/zjncsgCRpKM5iJ7qJfAEz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.606.0/LICENSE
```

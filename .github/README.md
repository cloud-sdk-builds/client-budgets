...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HwGWlVFgYbfTgz4zBsiy10tzBCEjxcEKA/tofHA7SETu/QijOY0B5VBBtJ50wDIQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.410.0/index.min.mjs": "sha384-HwGWlVFgYbfTgz4zBsiy10tzBCEjxcEKA/tofHA7SETu/QijOY0B5VBBtJ50wDIQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.410.0/LICENSE
```

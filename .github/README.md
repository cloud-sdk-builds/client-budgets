...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZFZ5HciAY0qT7xFdg223GVspnMNgd1/AxLdS67ch6i/b2sXPrt3tAZY9tsTA7NmD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.872.0/index.min.mjs": "sha384-ZFZ5HciAY0qT7xFdg223GVspnMNgd1/AxLdS67ch6i/b2sXPrt3tAZY9tsTA7NmD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.872.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RHchpMg7EuzNpIq75lnmTpoOF7kTnIDlRrpZOwpfo4OfXUnKsMYOFr/sS8v7PZkI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.267.0/index.min.mjs": "sha384-RHchpMg7EuzNpIq75lnmTpoOF7kTnIDlRrpZOwpfo4OfXUnKsMYOFr/sS8v7PZkI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.267.0/LICENSE
```

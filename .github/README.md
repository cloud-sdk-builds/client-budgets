...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+KRxScSL/mYekv2Opu7EQ1gbz6q/kuFD9r4CsSfqEW9HvgpYISuYUTzYnAl6stku
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.934.0/index.min.mjs": "sha384-+KRxScSL/mYekv2Opu7EQ1gbz6q/kuFD9r4CsSfqEW9HvgpYISuYUTzYnAl6stku"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.934.0/LICENSE
```

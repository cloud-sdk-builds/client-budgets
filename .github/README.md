...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-smUvmwVPjbvJXX9UZiVXs3yF1pc81l3/xMC6bgx0ibciYVjkg4zjeG58VbSlnlCA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.409.0/index.min.mjs": "sha384-smUvmwVPjbvJXX9UZiVXs3yF1pc81l3/xMC6bgx0ibciYVjkg4zjeG58VbSlnlCA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.409.0/LICENSE
```

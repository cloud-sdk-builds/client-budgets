...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hKeF4m6Rpal3H13IzbNyNlLVsoylA3ZoEFDVFkJYlaMAnV8IMszDhkqsCA5yjpxx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.34.0/index.min.mjs": "sha384-hKeF4m6Rpal3H13IzbNyNlLVsoylA3ZoEFDVFkJYlaMAnV8IMszDhkqsCA5yjpxx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.34.0/LICENSE
```

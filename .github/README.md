...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pWpXgi3T3iylX22RBfInL6zmgkHhy6KILGDvsZboLrC9399kl0b9+ivUvlun8xs0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.726.0/index.min.mjs": "sha384-pWpXgi3T3iylX22RBfInL6zmgkHhy6KILGDvsZboLrC9399kl0b9+ivUvlun8xs0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.726.0/LICENSE
```

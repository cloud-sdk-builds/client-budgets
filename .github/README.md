...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M5b/B1giC42l5KewTCqTaUlY/IBSvLNX6RV6YkqtjQmxSryXxi7OvnZy822Bz/pv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.575.0/index.min.mjs": "sha384-M5b/B1giC42l5KewTCqTaUlY/IBSvLNX6RV6YkqtjQmxSryXxi7OvnZy822Bz/pv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.575.0/LICENSE
```

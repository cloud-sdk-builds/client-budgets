...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-TmwnrAE5tiKEvX80UUm+leCiLI/n+wInieqdERX3QmG+h6VJeepipKp26AJSJytd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.658.1/index.min.mjs": "sha384-TmwnrAE5tiKEvX80UUm+leCiLI/n+wInieqdERX3QmG+h6VJeepipKp26AJSJytd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.658.1/LICENSE
```

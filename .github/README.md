...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KXSaXEfnmmS05NHVkoCAuTp96fJhBjt2UFhyLucPVW6P7BrWSoeD0NBAKjKteb5R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.80.0/index.min.mjs": "sha384-KXSaXEfnmmS05NHVkoCAuTp96fJhBjt2UFhyLucPVW6P7BrWSoeD0NBAKjKteb5R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.80.0/LICENSE
```

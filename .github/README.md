...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oQh5gVXQZizV5ibjwHe6FvXVERmZRbQtpG2zNVTuKMFHJY6nDDXvc0eLy+zXzKfj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.982.0/index.min.mjs": "sha384-oQh5gVXQZizV5ibjwHe6FvXVERmZRbQtpG2zNVTuKMFHJY6nDDXvc0eLy+zXzKfj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.982.0/LICENSE
```

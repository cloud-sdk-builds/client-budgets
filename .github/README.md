...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/D+cEhRPBNa7Y3egdswXrX92Nezfe5uaYOZGFglDszAYFkYXD+Psz7GXz+1g4ZJ6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.504.0/index.min.mjs": "sha384-/D+cEhRPBNa7Y3egdswXrX92Nezfe5uaYOZGFglDszAYFkYXD+Psz7GXz+1g4ZJ6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.504.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MXzNFIeBZoFg2ajyeE/mIfJ35NTKHut0M9J/rq5S/89bxF0HcSEBPVIFe6eKSu8K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.222.0/index.min.mjs": "sha384-MXzNFIeBZoFg2ajyeE/mIfJ35NTKHut0M9J/rq5S/89bxF0HcSEBPVIFe6eKSu8K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.222.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9VnP7mlBIuwNxj4+wUjlsuobHGMG3SIBjtJG9syx9nZxwmGPd/lPvvBYlEiyjVY/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.931.0/index.min.mjs": "sha384-9VnP7mlBIuwNxj4+wUjlsuobHGMG3SIBjtJG9syx9nZxwmGPd/lPvvBYlEiyjVY/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.931.0/LICENSE
```

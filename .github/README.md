...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u3RIsFc/pvqoabFKDbup+vhRmQAcZ4v3tlJJcIs/9y9nurXbJ9oibwJzq2fMzrHY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.714.0/index.min.mjs": "sha384-u3RIsFc/pvqoabFKDbup+vhRmQAcZ4v3tlJJcIs/9y9nurXbJ9oibwJzq2fMzrHY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.714.0/LICENSE
```

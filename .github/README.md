...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eJolMP9wMY+e72fgub4lQa/r411YX9vmCJaSmIoQE4CP1JYAsfgp3Z7n6cugN0a9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.846.0/index.min.mjs": "sha384-eJolMP9wMY+e72fgub4lQa/r411YX9vmCJaSmIoQE4CP1JYAsfgp3Z7n6cugN0a9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.846.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kz6Z2a2lj71y1hKfBPKg4rUTJKvGaMUUypoH0GUjxx3UR/TXBl46WBpdd7qUCYNK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.609.0/index.min.mjs": "sha384-kz6Z2a2lj71y1hKfBPKg4rUTJKvGaMUUypoH0GUjxx3UR/TXBl46WBpdd7qUCYNK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.609.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UXRfr1vW6lSGeontlEERl/DH1UBnZZfOSTCQM2fU5IjsAEqe7HrTYrDEJA1AKxkv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.964.0/index.min.mjs": "sha384-UXRfr1vW6lSGeontlEERl/DH1UBnZZfOSTCQM2fU5IjsAEqe7HrTYrDEJA1AKxkv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.964.0/LICENSE
```

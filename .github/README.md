...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R71/zZetwX7sU4OTK2mUMLBDWEeI1bNs1xpM6hMIvkWFN4sZ1Xu5VpJYk2z7qH+G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.682.0/index.min.mjs": "sha384-R71/zZetwX7sU4OTK2mUMLBDWEeI1bNs1xpM6hMIvkWFN4sZ1Xu5VpJYk2z7qH+G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.682.0/LICENSE
```

...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9K2jSQmzZPxulZ1gObqwdTia9uJaZ2NOWZRCpx/k11zPIEE3sp8gsYf9tOCh+yy/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.858.0/index.min.mjs": "sha384-9K2jSQmzZPxulZ1gObqwdTia9uJaZ2NOWZRCpx/k11zPIEE3sp8gsYf9tOCh+yy/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.858.0/LICENSE
```

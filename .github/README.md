...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rb9MBgbpIa3ITrMUXAoziQkSd4gJd6lgtstpuI0uqy2hSaw/R34tCXSA5BXDgOX9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.582.0/index.min.mjs": "sha384-rb9MBgbpIa3ITrMUXAoziQkSd4gJd6lgtstpuI0uqy2hSaw/R34tCXSA5BXDgOX9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.582.0/LICENSE
```

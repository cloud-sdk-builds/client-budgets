...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WM1+L4oVZ4dUxFIAC3gsVgP06O8da4pt3c+KdyFGnZdOqoN+pjOzIkvLQOV55A4p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.709.0/index.min.mjs": "sha384-WM1+L4oVZ4dUxFIAC3gsVgP06O8da4pt3c+KdyFGnZdOqoN+pjOzIkvLQOV55A4p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.709.0/LICENSE
```

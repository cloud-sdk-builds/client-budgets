...
[`@aws-sdk/client-budgets`](https://www.npmjs.com/package/@aws-sdk/client-budgets/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9M/nFp8rMtpbf7kqrRzqxu4VAhttXR7xQNt7X7JEiyIMUVUC89WpTimWVjkLouwM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-budgets": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-budgets@3.509.0/index.min.mjs": "sha384-9M/nFp8rMtpbf7kqrRzqxu4VAhttXR7xQNt7X7JEiyIMUVUC89WpTimWVjkLouwM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-budgets/blob/refs/tags/3.509.0/LICENSE
```
